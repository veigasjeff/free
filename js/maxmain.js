...
const resourceURLs = [
    'https://uwatchfree.vercel.app/my.css',
    'https://uwatchfree.vercel.app/js/maxmain.js',
...
// playlist_scrol.json
fetch("https://uwatchfree.vercel.app/movies.json")
...
fetch("https://uwatchfree.vercel.app/movies.json") // Update the path to your movies.json file
  .then(response => response.json())
  .then(data => {
    const movies = data;
