...
function ThePerfectFind({ movie }) {
      ...
      target: [
        {
          ...
          name: " Hijack (2023)",
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/Hijack-2023/Watch-Watch-Hijack-EP1-2023-TvSeries",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/Hijack-2023/Watch-Watch-Hijack-EP1-2023-TvSeries"
        />
        <meta
          property="og:image"
