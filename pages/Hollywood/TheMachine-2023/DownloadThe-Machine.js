...
function TheMachine({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/TheMachine-2023/DownloadThe-Machine",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/TheMachine-2023/DownloadThe-Machine"
        />
        <meta
          property="og:image"
