...
function TheMachine({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/TheMachine-2023/Watch-The-Machine-2023-Movie",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/TheMachine-2023/Watch-The-Machine-2023-Movie"
        />
        <meta
          property="og:image"
