...
const schemaData   = {
  ...
  "description": "Uwatchfree™ The Last of Us - 2023 Full Movie Online Free | Watch Movies, TV-Series & Sports Live Online Free"
...
<meta name="keywords" content="uwatchfree,watch free movies,full movie online free,hd movies,movie 2023,latest movie,dubbed movies,free movie download,watch the last of us movie,index of the last of us movie,the last of us movie 2023,the last of us movie online,watch the last of us movie online free,the last of us tv series,the last of us movie download,the last of us movie free download,the last of us movie download" />
...
<link rel="canonical" href="https://uwatchfree.vercel.app/Hollywood/LastOfUs-2023/" />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white"  style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>Watch The Last of Us (2023) </h1>

    <div className={styles['iframe-container']}>
      <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen  src="https://dood.yt/e/aupf0niqthlh" />
    </div>    
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
    <a href="../LastOfUs-2023/LastOfUs" > 
      <h2 >Click To Watch The Last of Us (2023) Server 1</h2></a></button>
   ...
   <h2 className="text-white font-bold text-xl ">  9.4 Out of 10</h2>
...
<div>
    ...
    <a href="https://www.imdb.com/title/tt3581920/" target="_blank" > 
...
<h2 ><strong>Director:</strong> Ali Abbasi</h2>
<h2 ><strong>Country:</strong> USA</h2>
<h2 ><strong>Starring:</strong> Pedro Pascal, Bella Ramsey, Henrik Mestad, Gabriel Luna, Jeffrey Pierce, Phillip A. Kovats, Merle Dandridge, Anna Torv, Lamar Johnson.</h2>
<h2 ><strong>Description:</strong> After a global pandemic destroys civilization, a hardened survivor takes charge of a 14-year-old girl who may be humanity's last hope.</h2>
</div>
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 "  onClick={togglePopup} >
        ...
        <div className="popup-overlay">
         ...
         <div className="popup ">
          ...
          <h2 className="text-2xl font-bold" >Offical Trailer The Last of Us (2023) </h2>
           <div className={styles['iframe-container']}>
 <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://sbhight.com/e/3jsspdzofdtw.html" />
 ...
 <h3  className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">The Last of Us (2023) </h3>
 <Link href="../../Hollywood/LastOfUs-2023/DownloadLFU1">
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
Download 
...
<h3 className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">The Last of Us (2023)</h3>
<Link href="../../Hollywood/LastOfUs-2023/DownloadLFU2">
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
Download 
