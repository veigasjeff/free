...
function togglePopup() {
  ...
  />
     <Head>
     <title>Watch Kaleidoscope EP 4 (2023) Full Movie Online Free | Uwatchfree™</title>
...
<div className={styles['iframe-container']}>
      <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen  src="https://sbbrisk.com/e/m12kza4h3wsp.html" />
    </div>    
