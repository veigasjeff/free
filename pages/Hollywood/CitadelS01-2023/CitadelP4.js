...
function CitadelP4({ movie }) {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch Citadel S01 (2023) Full Movie Online Free | Uwatchfree™
        </title>
        <meta
          name="robots"
        ...
        <meta
          name="keywords"
          content="uwatchfree,watch free movies,full movie online free,hd movies,movie 2023,latest movie,dubbed movies,free movie download,watch citadel s01 movie,index of citadel s01 movie,citadel s01 movie 2023,citadel s01  movie online,watch citadel s01 movie online free,citadel s01 tv series,citadel s01 movie download,citadel s01  movie free download,citadel s01 movie download"
        />
        ...
        <meta
          property="og:title"
          content="Watch Citadel S01 (2023) | Uwatchfree™"
        />
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/CitadelS01-2023/CitadelP1"
        />
        <meta
          property="og:image"
          content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1682771578/citadel-2023_ydg9yo.webp"
        />
        <meta
        ...
        <meta
          name="description"
          content="Watch Citadel S01 Full Movie Online on Uwatchfree™, You can also download Citadel S01 (2023) in full HD quality to watch later offline."
        />
      ...
      <div className="bg-gray-600 shadow ">
        ...
        <div className="flex justify-center">
          <Link href="../../Hollywood/CitadelS01-2023/CitadelP6">
            <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
              Episode 6
            </button>
          </Link>
