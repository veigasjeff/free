...
function ThePerfectFind({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/ThePerfectFind-2023/Watch-The-Perfect-Find-2023-Movie ",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/ThePerfectFind-2023/Watch-The-Perfect-Find-2023-Movie "
        />
        <meta
          property="og:image"
