...
function ThePerfectFind({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/ThePerfectFind-2023/The-Perfect-Find ",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/ThePerfectFind-2023/The-Perfect-Find "
        />
        <meta
          property="og:image"
      ...
      <div className="bg-gray-600 shadow ">
        ...
        />
           ...
           <a href="../../Hollywood/ThePerfectFind-2023/TPFD" >  
