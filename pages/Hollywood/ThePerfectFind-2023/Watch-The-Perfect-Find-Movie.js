...
function ThePerfectFind({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/ThePerfectFind-2023/Watch-The-Perfect-Find-Movie",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/ThePerfectFind-2023/Watch-The-Perfect-Find-Movie"
        />
        <meta
          property="og:image"
