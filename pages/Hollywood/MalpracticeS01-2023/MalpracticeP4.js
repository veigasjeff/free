...
<meta property="og:url" content="https://uwatchfree.vercel.app/Hollywood/MalpracticeS01-2023/MalpracticeP1" />
...
<meta name="description" content="Watch Malpractice S03 Full Movie Online on Uwatchfree™, You can also download Malpractice S01 (2023)
 in full HD quality to watch later offline." />

<link rel="canonical" href="https://uwatchfree.vercel.app/Hollywood/MalpracticeS01-2023/" />  
       </Head>
...
<ShareButtons url="https://uwatchfree.vercel.app" title="Watch Movies, TV-Series & Sports Live Online Free" image="https://uwatchfree.vercel.app/og_image.jpg" />
  ...
  Episode 5
      ...
      <Rating />
      <a href={movie.link} className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dMAL:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dMAL:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dMAL:bg-gray-900 group-hover:bg-opacity-0 " MALget="_blank">IMDb Rating: {movie.rating}</a>  
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dMAL:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dMAL:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dMAL:bg-gray-900 group-hover:bg-opacity-0 "  onClick={togglePopup} >
        ...
        <div className="popup-overlay">
         ...
         <div className="popup ">
               ...
               <h2 className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dMAL:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dMAL:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dMAL:bg-gray-900 group-hover:bg-opacity-0 " >  Close</h2>  
          </button>
