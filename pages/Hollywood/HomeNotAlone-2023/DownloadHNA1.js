...
function DownloadHNA1({ movie }) {
  ...
  const ldJsonData = JSON.stringify({
    ...
    "potentialAction": {
      ...
      "target": [
        {
          "@type": "EntryPoint",
          "name": "Home Not Alone (2023)",
          "urlTemplate": "https://uwatchfree.vercel.app/Hollywood/HomeNotAlone-2023/HomeNotAlone"
        },
        {
          "@type": "EntryPoint",
          "name": "Home Not Alone (2023)",
          "urlTemplate": "https://uwatchfree.vercel.app/Hollywood/HomeNotAlone-2023/HNASR1"
        }
      ]
    },
    "aggregateRating": {
  ...
  return (
    <div>
      ...
      />
    <Head>
     <title>Watch Home Not Alone (2023) Full Movie Online Free | Uwatchfree™</title>
...
<meta property="og:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610059/home-not-alone-2023_iet3qg.webp" />
...
<meta name="twitter:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610059/home-not-alone-2023_iet3qg.webp" />
...
<a href="../../Hollywood/HomeNotAlone-2023/HomeNotAlone" >
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0  ">
  Back
