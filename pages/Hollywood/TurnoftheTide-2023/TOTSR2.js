    ...
    episode: [
      {
        ...
        url: "https://uwatchfree.vercel.app/Hollywood/TurnoftheTide-2023/TOTSR1",
      },
      {
        "@type": "TVEpisode",
        name: "Turn Of the Tide S01 Episode 2",
        url: "https://uwatchfree.vercel.app/Hollywood/TurnoftheTide-2023/TOTSR2",
      },
      {
        "@type": "TVEpisode",
        name: "Turn Of the Tide S01 Episode 3",
        url: "https://uwatchfree.vercel.app/Hollywood/TurnoftheTide-2023/TOTSR3",
      },
      {
        "@type": "TVEpisode",
        name: "Turn Of the Tide S01 Episode 4",
        url: "https://uwatchfree.vercel.app/Hollywood/TurnoftheTide-2023/TOTSR4",
      },
      {
        "@type": "TVEpisode",
        name: "Turn Of the Tide S01 Episode 5",
        url: "https://uwatchfree.vercel.app/Hollywood/TurnoftheTide-2023/TOTSR5",
      },

      {
        "@type": "TVEpisode",
        name: "Turn Of the Tide S01 Episode 6",
        url: "https://uwatchfree.vercel.app/Hollywood/TurnoftheTide-2023/TOTSR6",
      },
      
      {
        "@type": "TVEpisode",
        name: "Turn Of the Tide S01 Episode 7",
        url: "https://uwatchfree.vercel.app/Hollywood/TurnoftheTide-2023/TOTSR8",
      },
      {
        "@type": "TVEpisode",
        name: "Turn Of the Tide S01 Episode 8",
        url: "https://uwatchfree.vercel.app/Hollywood/TurnoftheTide-2023/TOTSR7",
      },
      ...
      <div className="bg-gray-600 shadow ">
        ...
        <div className="grid grid-cols-1 mx-20 sm:grid-cols-2  x:grid-cols-3 gap-4">
          <div className="flex justify-center">
            <Link href="../../Hollywood/TurnoftheTide-2023/TOTSR1">
           ...
           <div className="flex justify-center">
            <Link href="../../Hollywood/TurnoftheTide-2023/TOTSR3">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
                Episode 3
              </button>
            </Link>
          ...
          <div className="flex justify-center">
            <Link href="../../Hollywood/TurnoftheTide-2023/TOTSR4">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
                Episode 4
              </button>
            </Link>
          ...
          <div className="flex justify-center">
            <Link href="../../Hollywood/TurnoftheTide-2023/TOTSR5">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
                Episode 5
              </button>
            </Link>
          ...
          <div className="flex justify-center">
            <Link href="../../Hollywood/TurnoftheTide-2023/TOTSR6">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
                Episode 6
              </button>
            </Link>
          ...
          <div className="flex justify-center">
            <Link href="../../Hollywood/TurnoftheTide-2023/TOTSR7">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
                Episode 7
              </button>
            </Link>
        ...
        <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
          <a href="../TurnoftheTide-2023/TurnoftheTideP2">
