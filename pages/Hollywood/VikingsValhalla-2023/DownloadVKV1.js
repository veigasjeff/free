...
<Script src="../../propler/ads.js" defer />
  ...
  <h2 classNameName="text-blue-500  title-font mb-3 my-5 font-bold text-2xl ">
     DOWNLOAD MOVIE VIKINKS VALHALLA (2023)  LINK BELOW </h2>
    
    <img classNameName="scale-100 hover:scale-110 ease-in duration-500 cursor-pointer rounded-3xl blur-invert  drop-shadowrounded-3xl"  src='/vikings-valhalla-2023.webp' alt='VIKINGS VALHALLA - 2023'  width={1000}  height={562.5}  loading="lazy"/>
