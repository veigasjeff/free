...
contentRating: movie.contentRating,
    ...
    episode: [
      {
        ...
        url: "https://uwatchfree.vercel.app/Hollywood/TheDays-2023/TDYSR1",
      },
      {
        "@type": "TVEpisode",
        name: "The Days S01 Episode 2",
        url: "https://uwatchfree.vercel.app/Hollywood/TheDays-2023/TDYSR2",
      },
      {
        "@type": "TVEpisode",
        name: "The Days S01 Episode 3",
        url: "https://uwatchfree.vercel.app/Hollywood/TheDays-2023/TDYSR3",
      },
      {
        "@type": "TVEpisode",
        name: "The Days S01 Episode 4",
        url: "https://uwatchfree.vercel.app/Hollywood/TheDays-2023/TDYSR4",
      },
      {
        "@type": "TVEpisode",
        name: "The Days S01 Episode 5",
        url: "https://uwatchfree.vercel.app/Hollywood/TheDays-2023/TDYSR5",
      },

      {
        "@type": "TVEpisode",
        name: "The Days S01 Episode 6",
        url: "https://uwatchfree.vercel.app/Hollywood/TheDays-2023/TDYSR6",
      },
      
      {
        "@type": "TVEpisode",
        name: "The Days S01 Episode 7",
        url: "https://uwatchfree.vercel.app/Hollywood/TheDays-2023/TDYSR7",
      },
      {
        "@type": "TVEpisode",
        name: "The Days S01 Episode 8",
        url: "https://uwatchfree.vercel.app/Hollywood/TheDays-2023/TDYSR8",
      },
    ...
    potentialAction: {
      ...
      target: {
        "@type": "EntryPoint",
        urlTemplate:
          "https://uwatchfree.vercel.app/Hollywood/TheDays-2023/TheDaysP1",
      },
    },
    additionalProperty: {
      "@type": "PropertyValue",
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/TheDays-2023/TheDaysP1"
        />
        <meta
          property="og:image"
      ...
      <div className="bg-gray-600 shadow ">
        ...
        <div className="grid grid-cols-1 mx-20 sm:grid-cols-2  x:grid-cols-3 gap-4">
          <div className="flex justify-center">
            <Link href="../../Hollywood/TheDays-2023/TDYSR1">
           ...
           <div className="flex justify-center">
            <Link href="../../Hollywood/TheDays-2023/TDYSR3">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
                Episode 3
              </button>
            </Link>
          ...
          <div className="flex justify-center">
            <Link href="../../Hollywood/TheDays-2023/TDYSR4">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
                Episode 4
              </button>
            </Link>
          ...
          <div className="flex justify-center">
            <Link href="../../Hollywood/TheDays-2023/TDYSR5">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
                Episode 5
              </button>
            </Link>
          ...
          <div className="flex justify-center">
            <Link href="../../Hollywood/TheDays-2023/TDYSR6">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
                Episode 6
              </button>
            </Link>
          ...
          <div className="flex justify-center">
            <Link href="../../Hollywood/TheDays-2023/TDYSR7">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
                Episode 7
              </button>
            </Link>
            ...
            <div className="flex justify-center">
            <Link href="../../Hollywood/TheDays-2023/TDYSR8">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
                Episode 8
              </button>
            </Link>
