...
const schemaData   = {
  ...
  "headline": "Knock at the Cabin (2023) | uwatchfree™",
  "image": "https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610079/knock-at-the-cabin-2023_wgkfzs.webp",
  ...
  "description": "uwatchfree™ Knock at the Cabin (2023) | Watch now the Best TV shows and Movies"
...
function togglePopup() {
  ...
  />
     <Head>
     <title>Watch Knock at the Cabin (2023) | uwatchfree™</title>
...
<meta property="og:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610079/knock-at-the-cabin-2023_wgkfzs.webp" />
...
<meta name="twitter:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610079/knock-at-the-cabin-2023_wgkfzs.webp" />
...
<ShareButtons url="https://uwatchfree.vercel.app" title="Watch Movies, TV-Series & Sports Live Online Free" image="https://uwatchfree.vercel.app/og_image.jpg" />
   ...
   <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
    <a href="../KnockAtTheCabin-2023/KACSR2" > 
      <h1 > Watch Knock at the Cabin (2023) Server 2</h1></a></button>
...
<div>
    ...
    <a href="https://www.imdb.com/title/tt15679400/" > 
      <h1 >IDBM Ranking</h1></a></button></div>
<h2 className=" text-medium font-sm text-center dark:text-white text-white"><strong>Genre:</strong> Horror, Mystery, Thriller.</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Release year:</strong> 2023</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Director:</strong> M. Night Shyamalan</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Country:</strong> USA</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white "><strong>Starring:</strong> Dave Bautista, Jonathan Groff, Rupert Grint, Nikki Amuka-Bird, Ben Aldridge, Abby Quinn, Kristen Cui, McKenna Kerrigan, Ian Merrill Peakes, Denise Nakano, Rose Luardo.</h2>
<h2 className="text-medium font-sm text-center dark:text-white text-white"><strong>Description:</strong> While vacationing, a girl and her parents are taken hostage by armed strangers who demand that the family make a choice to avert the apocalypse.</h2>
