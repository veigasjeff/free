...
function WarhorseOne ({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/Warhorse-One-2023/WARH",
  ...
  return (
    ...
    <Head>
        <title>
          Watch  Warhorse One (2023) Full Movie Online Free | Uwatchfree™
        </title>
        <meta
          name="robots"
      ...
      <meta
        ...
        <meta
          property="og:title"
          content="Watch Warhorse One (2023) | Uwatchfree™"
        />
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/Warhorse-One-2023/WARH"
        />
        <meta
          property="og:image"
        ...
        <link
          rel="canonical"
          href="https://uwatchfree.vercel.app/Hollywood/Warhorse-One-2023/WarhorseOne"
        />
      </Head>
      ...
      <div className="bg-gray-600 shadow ">
        ...
        />
          <button className="relative inline-flex items-center animate-pulse rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110 cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
           <a href="../../Hollywood/Warhorse-One-2023/WarhorseOne" >  
      ...
      <h3 className="mb-9 text-bg  text-black-500 text-blue-600 text-center xl:px-4 ">
        ...
        <h2
          ...
          style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
        >
          Listen to Audio Summary Warhorse One (2023)
        </h2>
        <div
        ...
        >
          ...
          >
           <source src="https://ik.imagekit.io/gmcl6xvq6/WARHORSE_ONE__2023__Official_Trailer.mp4?updatedAt=1688789629616" />
          </audio>
        </div>
        ...
        >
          ...
          <a href="https://www.imdb.com/name/nm0835001/?ref_=ttfc_fc_cl_t1" target="_blank">
            <div className="circle">
              <Image
                src="https://flxt.tmsimg.com/assets/208203_v9_ba.jpg"
                alt="Johnny Strong Image"
                layout="responsive"
                width={250}
                height={250}
                title="Johnny Strong."
            ...
            <a href="https://www.imdb.com/name/nm13232361/?ref_=ttfc_fc_cl_t2" target="_blank">
            <div className="circle">
              <Image
                src="https://res.cloudinary.com/dezf3wemk/image/upload/v1689022088/blank-profile-picture_lccaig.webp"
                alt=" Athena Durner Image"
                layout="responsive"
                width={250}
                height={250}
                title=" Athena Durner."
            ...
            <a href="https://www.imdb.com/name/nm4360199/?ref_=ttfc_fc_cl_t3" target="_blank">
            <div className="circle">
              <Image
                src="https://nettv4u.com/serialimages/25-02-2020/raj-kala.jpg"
                alt=" Raj Kala Image"
                layout="responsive"
                width={250}
                height={250}
            ...
            <a href="https://www.imdb.com/name/nm9006041/?ref_=ttfc_fc_cl_t4" target="_blank">
            <div className="circle">
              <Image
                src="https://res.cloudinary.com/dezf3wemk/image/upload/v1689022088/blank-profile-picture_lccaig.webp"
                alt=" James Sherrill Image"
                layout="responsive"
                width={250}
                height={250}
                title=" James Sherrill."
              />
            </div></a>
            <a href="https://www.imdb.com/name/nm10050209/?ref_=ttfc_fc_cl_t5" target="_blank">
            <div className="circle">
              <Image
                src="https://res.cloudinary.com/dezf3wemk/image/upload/v1689022088/blank-profile-picture_lccaig.webp"
                alt="Siya Image"
          ...
          <li>Director: {movie.director}</li>
                 ...
                 <a href="https://www.imdb.com/name/nm0835001/?ref_=ttfc_fc_dr1" target="_blank">
      ...
      {isHovered && (
        <img
          src="https://res.cloudinary.com/dezf3wemk/image/upload/v1689022088/blank-profile-picture_lccaig.webp" // Replace with the actual path or URL of the hover image
        ...
        />
          ...
          <h2
            ...
            style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
          >
            In the Movie Warhorse One - 2023
          </h2>
