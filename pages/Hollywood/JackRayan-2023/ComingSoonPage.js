...
const ComingSoonPage = () => {
  ...
  return (
    ...
    <div className={styles.content}>
      <h2>Coming Soon</h2>
      <div className={styles.timing} ref={timingRef}>24h : 00m : 00s</div>
      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum cupiditate tempore, sapiente dicta, iusto atque!</p>
