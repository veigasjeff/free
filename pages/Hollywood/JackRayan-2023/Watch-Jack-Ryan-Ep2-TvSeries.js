...
function JackRyan ({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/JackRayan-2023/Watch-Jack-Ryan-Ep2-TvSeries",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/JackRayan-2023/Watch-Jack-Ryan-Ep2-TvSeries"
        />
        <meta
          property="og:image"
      ...
      <div className="bg-gray-600 shadow ">
        ...
        >
          ...
          <div className="flex justify-center">
            <Link href="../../Hollywood/JackRayan-2023/Watch-Jack-Ryan-Ep1-TvSeries">
