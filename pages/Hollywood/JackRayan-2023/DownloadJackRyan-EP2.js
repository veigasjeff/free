...
function JackRyan ({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/JackRayan-2023/DownloadJackRyan-EP2",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/JackRayan-2023/DownloadJackRyan-EP2"
        />
        <meta
          property="og:image"
      ...
      <div className="bg-gray-600 shadow ">
        ...
        >
          ...
          <div className="flex justify-center">
            <Link href="../../Hollywood/JackRayan-2023/DownloadJackRyan-EP1">
