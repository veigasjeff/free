  ...
  const ldJsonData = JSON.stringify({
    ...
    episode: [
      {
        ...
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/TheArkP1",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 2",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/TheArkP2",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 3",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/TheArkP3",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 4",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/TheArkP4",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 5",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/TheArkP5",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 6",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/TheArkP6",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 7",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/TheArkP7",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 8",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/TheArkP8",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 9",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/TheArkP9",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 10",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/TheArkP10",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 11",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/TheArkP11",
      },
    ],
    author: [
      {
    ...
    potentialAction: {
      ...
      target: {
        "@type": "EntryPoint",
        urlTemplate:
          "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/TheArkP1",
      },
    },
  });
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          name="keywords"
          content="uwatchfree,watch free movies,full movie online free,hd movies,movie 2023,latest movie,dubbed movies,free movie download,watch the ark movie,index of the ark movie,the ark movie 2023,the ark movie online,watch the ark movie online free,the ark tv series,the ark movie download,the ark movie free download,the ark movie download"
        />
        ...
        <meta
          property="og:title"
          content="Watch The Ark (2023) | Uwatchfree™"
        />
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/TheArk-2023/TheArkP1"
        />
        <meta
          property="og:image"
          content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610130/the-ark-2023_alwydj.webp"
        />
        <meta
        ...
        <meta
          name="description"
          content="Watch The Ark Full Movie Online on Uwatchfree™, You can also download The Ark (2023) in full HD quality to watch later offline."
        />
      ...
      <div className="bg-gray-600 shadow ">
        ...
        <div className="flex justify-center">
          <Link href="../../Hollywood/TheArk-2023/TheArkP12">
            <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
              Episode 12
            </button>
          </Link>
