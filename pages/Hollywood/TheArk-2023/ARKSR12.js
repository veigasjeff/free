    ...
    episode: [
      {
        ...
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/ARKSR1",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 2",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/ARKSR2",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 3",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/ARKSR3",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 4",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/ARKSR4",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 5",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/ARKSR5",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 6",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/ARKSR6",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 7",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/ARKSR7",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 8",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/ARKSR8",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 9",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/ARKSR9",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 10",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/ARKSR10",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 11",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/ARKSR11",
      },
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 12",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/ARKSR12",
      },
    ],
    author: [
      {
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta property="og:title" content="Watch TheArk (2023) | Uwatchfree™" />
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/TheArk-2023/ARKSR1"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="twitter:title"
          content="Watch TheArk (2023) | Uwatchfree™"
        />
        <meta
          name="twitter:image"
          content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610130/the-ark-2023_alwydj.webp"
        ...
        <meta
          name="description"
          content="Watch TheArk Full Movie Online on Uwatchfree™, You can also download TheArk (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://uwatchfree.vercel.app/Hollywood/TheArk-2023/ARKSR1"
        />
      </Head>
      ...
      <div className="bg-gray-600 shadow ">
        ...
        <div className="grid grid-cols-1 mx-20 sm:grid-cols-2  x:grid-cols-3 gap-4">
          ...
          <div className="flex justify-center">
            <Link href="../../Hollywood/TheArk-2023/ARKSR11">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
                Episode 11
              </button>
            </Link>
          ...
          <div className="flex justify-center">
            <Link href="../../Hollywood/TheArk-2023/ARKSR12">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
                Episode 12
              </button>
            </Link>
