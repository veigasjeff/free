...
function TheArkP12({ movie }) {
  ...
  const ldJsonData = JSON.stringify({
    ...
    episode: [
      ...
      {
        "@type": "TVEpisode",
        name: "The Ark Episode 12",
        url: "https://uwatchfree.vercel.app/Hollywood/TheArk-2023/TheArkP12",
      },
    ],
    author: [
      {
