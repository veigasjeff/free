...
<link rel="canonical" href="https://uwatchfree.vercel.app/Hollywood/SupermanAndLois-2023/" />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white"  style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>Watch Superman And Lois (2023) </h1>
      ...
      <div className={styles['iframe-container']}>
       <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://lvturbo.com/e/kv0r6gp6stbb.html" />
    </div>    
