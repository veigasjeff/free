...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatchfree.vercel.app/Bollywood/SupermanAndLois-2023/SupermanAndLoisP1"
    
  },
  "headline": "Superman & Lois - S3 (2023) Tv Show Online Free | Uwatchfree™",
  ...
  "description": "Uwatchfree™ Superman & Lois - S3 (2023) Tv Show Online Free | Watch Movies, TV-Series & Sports Live Online Free"
...
function togglePopup() {
  ...
  />
     <Head>
     <title>Watch Superman & Lois - S3 (2023) Tv Show Online Free | Uwatchfree™</title>
...
<meta property="og:url" content="https://uwatchfree.vercel.app/Bollywood/SupermanAndLois-2023/SupermanAndLoisP1" />
...
<meta name="description" content="Watch Superman & Lois - S3 (2023) Tv Show Online on Uwatchfree™, You can also download Superman & Lois - S3 (2023)  in full HD quality to watch later offline." />
<script src="../../propler/ads.js" defer></script> 
<link rel="canonical" href="https://uwatchfree.vercel.app/Bollywood/SupermanAndLois-2023/" />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white">Watch Superman & Lois - S3 (2023)  </h1>

    <div className={styles['iframe-container']}>
    <iframe classNameName="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://sbface.com/e/kv0r6gp6stbb.html" />
    </div>     
    ...
    <a href="../SupermanAndLois-2023/SALSR2" > 
      <h2 >Click To Watch Superman & Lois - S3 (2023) Server 2</h2></a></button>
...
<div>
    ...
    <a href="https://www.imdb.com/title/tt11192306/" target="_blank" > 
...
<h2 ><strong>Production Company:</strong>  CW USA  <img className=" relative inline-flex bg-white items-right justify-center rounded-3xl"  src='/cw.webp' alt='CW USA (2023)'  width={50} height={100} loading="lazy"/>
 </h2>
<h2 ><strong>Creators :</strong> Greg Berlanti, Todd Helbing</h2>
<h2 ><strong>Country:</strong> USA </h2>
<h2 ><strong>Starring:</strong> Tyler Hoechlin, Elizabeth Tulloch, Alex Garfin, Erik Valdez, Inde Navarrette, Wolé Parks, Dylan Walsh, Emmanuelle Chriqui, Jordan Elsass, Sofia Hasmik, Tayler Buck, Daisy Tormé, Adam Rayner.</h2>
<h2 ><strong>Description:</strong> The world's most famous superhero and comic books' most famous journalist face the pressures and complexities that come with balancing work, justice, and parenthood in today's society.</h2>
</div>
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 "  onClick={togglePopup} >
        ...
        <div className="popup-overlay">
         ...
         <div className="popup ">
          ...
          <h2 className="text-2xl font-bold" >Offical Trailer Superman & Lois - S3 (2023) </h2>
           <div className={styles['iframe-container']}>
 <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://sbface.com/e/6gse7x30mctv.html" />
    ...
    <h3  className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">Superman & Lois - S3 (2023) </h3>
 <Link href="../../Hollywood/SupermanAndLois-2023/DownloadSAL1">
...
<h3  className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">Superman & Lois - S3 (2023)</h3>
<Link href="../../Hollywood/SupermanAndLois-2023/DownloadSAL2">
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
Download 
...
export default SupermanAndLoisP2 ;