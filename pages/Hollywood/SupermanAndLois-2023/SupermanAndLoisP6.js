...
function SupermanAndLoisP6({ movie }) {
...
<meta name="keywords" content="uwatchfree,watch free movies,full movie online free,hd movies,movie 2023,latest movie,dubbed movies,free movie download,watch superman and lois s01 movie,index of superman and lois s01 movie,superman and lois s01 movie 2023,superman and lois s01 movie online,watch superman and lois s01 movie online free,superman and lois s01 tv series,superman and lois s01 movie download,superman and lois s01 movie free download,superman and lois s01 movie download" />
...
<meta name="description" content="Watch Superman And Lois S03 Full Movie Online on Uwatchfree™, You can also download Superman and Lois S03 (2023)
...
<ShareButtons url="https://uwatchfree.vercel.app" title="Watch Movies, TV-Series & Sports Live Online Free" image="https://uwatchfree.vercel.app/og_image.jpg" />
  ...
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dSAL:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dSAL:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dSAL:bg-gray-900 group-hover:bg-opacity-0 ">
  Episode 1
      </button></Link>
    </div>
    <div className="flex justify-center">
  ...
  Episode 6
           ...
           <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dSAL:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dSAL:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dSAL:bg-gray-900 group-hover:bg-opacity-0 ">
           <a href="../SupermanAndLois-2023/SALSR6" >  
      <h2 > Watch {movie.name} (2023) Server 2</h2></a></button>
      <Rating />
      <a href={movie.link} className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dSAL:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dSAL:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dSAL:bg-gray-900 group-hover:bg-opacity-0 " SALget="_blank">IMDb Rating: {movie.rating}</a>  
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dSAL:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dSAL:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dSAL:bg-gray-900 group-hover:bg-opacity-0 "  onClick={togglePopup} >
        ...
        <div className="popup-overlay">
         ...
         <div className="popup ">
               ...
               <h2 className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dSAL:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dSAL:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dSAL:bg-gray-900 group-hover:bg-opacity-0 " >  Close</h2>  
          </button>
...
<div className="flex flex-col py-10  text-blue-600 text-center items-center justify-center">
 ...
 <h3  className="text-2xl font-bold leading-norSAL mt-0 mb-2 text-blue-600 ">{movie.name} (2023) </h3>
...
export default SupermanAndLoisP6;
