...
function TheChemistryOfDeathE2({ movie }) {
  if (!movie) {
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/TheChemistryOfDeath-2023/Watch-TvSeries-The-Chemistry-Of-Death-E2"
        />
        <meta
          property="og:image"
...
export default TheChemistryOfDeathE2;
