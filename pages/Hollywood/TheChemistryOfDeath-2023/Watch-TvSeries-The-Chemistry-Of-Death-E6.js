...
function TheChemistryOfDeathE6({ movie }) {
  ...
  const ldJsonData = JSON.stringify({
    ...
    episode: [
      {
        ...
        url: "https://uwatchfree.vercel.app/Hollywood/TheChemistryOfDeath-2023/Watch-TvSeries-The-Chemistry-Of-Death-E1",
      },
      {
        "@type": "TVEpisode",
        name: "The Chemistry Of Death Episode 2",
        url: "https://uwatchfree.vercel.app/Hollywood/TheChemistryOfDeath-2023/Watch-TvSeries-The-Chemistry-Of-Death-E2",
      },
      {
        "@type": "TVEpisode",
        name: "The Chemistry Of Death Episode 3",
        url: "https://uwatchfree.vercel.app/Hollywood/TheChemistryOfDeath-2023/Watch-TvSeries-The-Chemistry-Of-Death-E3",
      },
      {
        "@type": "TVEpisode",
        name: "The Chemistry Of Death Episode 4",
        url: "https://uwatchfree.vercel.app/Hollywood/TheChemistryOfDeath-2023/Watch-TvSeries-The-Chemistry-Of-Death-E4",
      },
      {
        "@type": "TVEpisode",
        name: "The Chemistry Of Death Episode 5",
        url: "https://uwatchfree.vercel.app/Hollywood/TheChemistryOfDeath-2023/Watch-TvSeries-The-Chemistry-Of-Death-E5",
      },
    ...
    potentialAction: {
      ...
      target: {
        "@type": "EntryPoint",
        urlTemplate:
          "https://uwatchfree.vercel.app/Hollywood/TheChemistryOfDeath-2023/Watch-TvSeries-The-Chemistry-Of-Death-E1",
      },
    },
    additionalProperty: {
      "@type": "PropertyValue",
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/TheChemistryOfDeath-2023/Watch-TvSeries-The-Chemistry-Of-Death-E6"
        />
        <meta
          property="og:image"
    ...
    <source src="https://res.cloudinary.com/db36kfuq3/video/upload/v1687100340/CHEM_rlh5uu.mp3" />
        ...
        <div className="grid grid-cols-1 mx-20 sm:grid-cols-2  x:grid-cols-3 gap-4">
          <div className="flex justify-center">
            <Link href="../../Hollywood/TheChemistryOfDeath-2023/Watch-TvSeries-The-Chemistry-Of-Death-E1">
          ...
          <div className="flex justify-center">
            <Link href="../../Hollywood/TheChemistryOfDeath-2023/Watch-TvSeries-The-Chemistry-Of-Death-E2">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
                Episode 2
              </button>
            </Link>
          ...
          <div className="flex justify-center">
            <Link href="../../Hollywood/TheChemistryOfDeath-2023/Watch-TvSeries-The-Chemistry-Of-Death-E3">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
                Episode 3
              </button>
            </Link>
          ...
          <div className="flex justify-center">
            <Link href="../../Hollywood/TheChemistryOfDeath-2023/Watch-TvSeries-The-Chemistry-Of-Death-E4">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
                Episode 4
              </button>
            </Link>
          ...
          <div className="flex justify-center">
            <Link href="../../Hollywood/TheChemistryOfDeath-2023/Watch-TvSeries-The-Chemistry-Of-Death-E5">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
                Episode 5
              </button>
            </Link>
...
export default TheChemistryOfDeathE6;
