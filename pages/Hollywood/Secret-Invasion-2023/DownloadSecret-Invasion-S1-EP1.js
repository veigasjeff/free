...
function RideOn ({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/Secret-Invasion-2023/DownloadSecret-Invasion-S1-EP1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/Secret-Invasion-2023/DownloadSecret-Invasion-S1-EP1"
        />
        <meta
          property="og:image"
      ...
      <div className="bg-gray-600 shadow ">
        ...
        <div className="flex justify-center">
            <Link href="../../Hollywood/Secret-Invasion-2023/DownloadSecret-Invasion-S1-EP2">
