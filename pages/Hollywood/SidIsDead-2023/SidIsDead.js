...
function SidIsDead({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/SidIsDead-2023/SidIsDead",
        },
        {
          "@type": "EntryPoint",
          name: "Sid Is Dead (2023)",
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/SidIsDead-2023/SIDSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch Sid Is Dead (2023) Full Movie Online Free | Uwatchfree™
        </title>
        <meta
          name="robots"
        ...
        <meta
          property="og:title"
          content="Watch Sid Is Dead (2023) | Uwatchfree™"
        />
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/SidIsDead-2023/SidIsDead"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch SidIsDead Full Movie Online on Uwatchfree™, You can also download Sid Is Dead (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://uwatchfree.vercel.app/Hollywood/SidIsDead-2023/SidIsDead"
        />
      </Head>
