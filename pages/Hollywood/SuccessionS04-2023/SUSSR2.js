...
function SUSSR2({ movie }) {
  ...
  const schemaData   = {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://uwatchfree.vercel.app/Hollywood/SuccessionS04-2023/SuccessionP1"
      
    },
    "headline": " Succession S04 (2023) Full Movie Online Free | Uwatchfree™",
    ...
    "description": "Uwatchfree™  Succession S04 (2023) Full Movie Online Free | Watch Movies, TV-Series & Sports Live Online Free"
...
<meta property="og:url" content="https://uwatchfree.vercel.app/Hollywood/SuccessionS04-2023/SuccessionP1" />
...
<link rel="canonical" href="https://uwatchfree.vercel.app/Hollywood/SuccessionS04-2023/" />  
       </Head>
...
<ShareButtons url="https://uwatchfree.vercel.app" title="Watch Movies, TV-Series & Sports Live Online Free" image="https://uwatchfree.vercel.app/og_image.jpg" />
    ...
    <Link href="../../Hollywood/SuccessionS04-2023/SUSSR1">
  ...
  Episode 1
    ...
    <div className="flex justify-center">
    <Link href="../../Hollywood/SuccessionS04-2023/SUSSR2">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dSUS:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dSUS:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dSUS:bg-gray-900 group-hover:bg-opacity-0 ">
  Episode 2
      </button></Link>
    </div>
    <div className="flex justify-center">
    <Link href="../../Hollywood/SuccessionS04-2023/SUSSR3">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dSUS:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dSUS:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dSUS:bg-gray-900 group-hover:bg-opacity-0 ">
  Episode 3
      </button></Link>
      </div>
           ...
           <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dSUS:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dSUS:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dSUS:bg-gray-900 group-hover:bg-opacity-0 ">
           <a href="../SuccessionS04-2023/SuccessionP2" >  
      <h2 > Watch {movie.name} (2023) Server 1</h2></a></button>
      <Rating />
      <a href={movie.link} className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dSUS:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dSUS:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dSUS:bg-gray-900 group-hover:bg-opacity-0 " target="_blank">IMDb Rating: {movie.rating}</a>  
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dSUS:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dSUS:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dSUS:bg-gray-900 group-hover:bg-opacity-0 "  onClick={togglePopup} >
