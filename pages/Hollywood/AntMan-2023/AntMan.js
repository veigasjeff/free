...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatchfree.vercel.app/Hollywood/AntMan-2023/Ant-Man"
    
  },
  "headline": "Ant-Man and the Wasp Quantumania (2023) Full Movie Online Free | Uwatchfree™",
  "image": "https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681609946/ant-Man-and-the-wasp-2023_eotcmf.webp",
  ...
  "description": "Uwatchfree™ Ant-Man and the Wasp Quantumania (2023) Full Movie Online Free | Watch Movies, TV-Series & Sports Live Online Free"
...
<meta property="og:title" content="Watch Ant-Man and the Wasp Quantumania (2023) | Uwatchfree™" />
<meta property="og:url" content="https://uwatchfree.vercel.app/Hollywood/AntMan-2023/Ant-Man" />
<meta property="og:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681609946/ant-Man-and-the-wasp-2023_eotcmf.webp" />
<meta property="og:image:secure_url" content="https://uwatchfree.vercel.app/" />
<meta property="og:image:width" content="1280" />
<meta property="og:image:height" content="720" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:title" content="Watch Ant-Man and the Wasp Quantumania (2023) | Uwatchfree™" />
<meta name="twitter:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681609946/ant-Man-and-the-wasp-2023_eotcmf.webp" />
<meta name="description" content="Watch Ant-Man and the Wasp Quantumania (2023) Full Movie Online on Uwatchfree™, You can also download Ant-Man and the Wasp Quantumania (2023) in full HD quality to watch later offline." />

<link rel="canonical" href="https://uwatchfree.vercel.app/Hollywood/AntMan-2023/" />
...
<Script src="../../propler/ads.js" defer />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white"  style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>Watch Ant-Man and the Wasp Quantumania (2023) </h1>

     <div className=" flex container flex-col items-center justify-center mx-5 my-5 ">
      <Ad />
      </div>  
<div className={styles['iframe-container']}>
       <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://sbbrisk.com/e/ahxdoap72evm.html" />
    </div> 
...
<ShareButtons url="https://uwatchfree.vercel.app" title="Watch Movies, TV-Series & Sports Live Online Free" image="https://uwatchfree.vercel.app/og_image.jpg" />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white"  style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>Watch Ant-Man and the Wasp Quantumania (2023) Hindi Dubbed  </h1>

 <div className=" flex container flex-col items-center justify-center mx-5 my-5 ">
      <Ad />
      </div>  
<div className={styles['iframe-container']}>
       <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://sbbrisk.com/e/xr42ysd8wr4r.html" />
    </div>    
    <h3 className="mb-9 text-bg  text-black-500 text-red-600 text-center xl:px-4 ">*Note: Pls Select the in the Player to Change your Language of your Choice and Setting  to Change the Quality of Video.</h3>
<ShareButtons url="https://uwatchfree.vercel.app" title="Watch Movies, TV-Series & Sports Live Online Free" image="https://uwatchfree.vercel.app/og_image.jpg" />
 ...
 <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
    <a href="../AntMan-2023/ATMSR2" > 
      <h2 > Watch Ant-Man and the Wasp Quantumania (2023) Server 2</h2></a></button>
   ...
   <h2 className="text-white font-bold text-xl ">  6.6 Out of 10</h2>
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 "  onClick={togglePopup} >
        ...
        <div className="popup-overlay">
         ...
         <div className="popup ">
          ...
          <h2 className="text-2xl font-bold" >Offical Trailer Ant-Man and the Wasp Quantumania (2023) </h2>
            <div className=" flex container flex-col items-center justify-center mx-5 my-5 ">
      <Ad />
      </div>  
<div className={styles['iframe-container']}>
 <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://sbbrisk.com/e/hsabolqx974o.html" />
...
<div className="flex flex-col py-10  text-blue-600 text-center items-center justify-center">
 ...
 <h3  className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">Ant-Man and the Wasp Quantumania (2023) </h3>
 <Link href="../../Hollywood/AntMan-2023/DownloadATM1">
...
<h3 className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">Ant-Man and the Wasp Quantumania (2023)</h3>
<Link href="../../Hollywood/AntMan-2023/DownloadATM2">
<button className="relative inline-flex items-center rounded-3xl  justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-white scale-100 hover:scale-110 ease-in duration-500 cursor-pointer">  
<span className="relative px-5 py-2.5  transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0 ">
Download 
</span>
...
<a href="../../HollywoodAds">  <h3 className="text-medium font-bold py-10 leading-normal m-10 mt-0 mb-2 text-blue-600 "> 
