...
function DaughteroftheBride ({ movie }) {
      ...
      target: [
        {
          ...
          name: " Sheroes (2023)",
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/Sheroes-2023/Watch-Sheroes-2023-Movie",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/Sheroes-2023/Watch-Sheroes-2023-Movie"
        />
        <meta
          property="og:image"
      ...
      <div className="bg-gray-600 shadow ">
        ...
        <h2
          ...
          style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
        >
          Listen to Audio Summary The Movie  Sheroes (2023)
        </h2>
        <div
