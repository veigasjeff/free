...
function HuntClub ({ movie }) {
      ...
      target: [
        {
          ...
          name: " Hunt Club (2023)",
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/Hunt-Club-2023/HuntClub",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        <title>
          Watch  Hunt Club (2023) Full Movie Online Free | Uwatchfree™
        </title>
        <meta
          name="robots"
      ...
      <meta
        ...
        <meta
          property="og:title"
          content="Watch Hunt Club (2023) | Uwatchfree™"
        />
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/Hunt-Club-2023/HuntClub"
        />
        <meta
          property="og:image"
          content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1688789860/Hunt_Club_2023_zdekbb.webp"
        />
        <meta
      ...
      <div className="bg-gray-600 shadow ">
        ...
        />
          <button className="relative inline-flex items-center animate-pulse rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110 cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
           <a href="../../Hollywood/Hunt-Club-2023/HUCB" >  
      ...
      <h3 className="mb-9 text-bg  text-black-500 text-blue-600 text-center xl:px-4 ">
        ...
        <h2
          ...
          style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
        >
          Listen to Audio Summary Hunt Club (2023)
        </h2>
        <div
        ...
        >
          ...
          >
           <source src="https://ik.imagekit.io/gmcl6xvq6/Hunt_Club_Official-Trailer-2023.mp4?updatedAt=1689014796540" />
          </audio>
        </div>
        ...
        >
          ...
          <a href="https://www.imdb.com/name/nm0002546/?ref_=ttfc_fc_cl_t1" target="_blank">
            <div className="circle">
              <Image
                src="https://ntvb.tmsimg.com/assets/assets/157705_v9_bb.jpg"
                alt="Mena Suvari Image"
                layout="responsive"
                width={250}
                height={250}
                title="Mena Suvari."
            ...
            <a href="https://www.imdb.com/name/nm0000680/?ref_=ttfc_fc_cl_t2" target="_blank">
            <div className="circle">
              <Image
                src="https://assets.mycast.io/actor_images/actor-casper-van-dien-504_large.jpeg?1577589716"
                alt="Casper Van Dien Image"
                layout="responsive"
                width={250}
                height={250}
                title="Casper Van Dien."
              />
            </div></a>
            <a href="https://www.imdb.com/name/nm3816797/?ref_=ttfc_fc_cl_t3" target="_blank">
            <div className="circle">
              <Image
                src="https://upload.wikimedia.org/wikipedia/commons/f/f0/Will_Peltz%28cropped%29.jpg"
                alt=" Will Peltz Image"
                layout="responsive"
                width={250}
                height={250}
                title=" Will Peltz."
            ...
            <a href="https://www.imdb.com/name/nm3389576/?ref_=ttfc_fc_cl_t4" target="_blank">
            <div className="circle">
              <Image
                src="https://m.media-amazon.com/images/M/MV5BMjMyMjA2OTQ3OF5BMl5BanBnXkFtZTgwNTEyODk2MDE@._V1_QL75_UX140_CR0,0,140,140_.jpg"
                alt="Maya Stojan Image"
                layout="responsive"
                width={250}
                height={250}
                title="Maya Stojan."
            ...
            <a href="https://www.imdb.com/name/nm0000620/?ref_=ttfc_fc_cl_t5" target="_blank">
            <div className="circle">
              <Image
                src="https://assets-in.bmscdn.com/iedb/artist/images/website/poster/large/mickey-rourke-1474-24-03-2017-12-33-47.jpg"
                alt="Mickey Rourke Image"
                layout="responsive"
                width={250}
                height={250}
                title="Mickey Rourke."
          ...
          <li>Director: {movie.director}</li>
                 ...
                 <a href="https://www.imdb.com/name/nm6230910/?ref_=ttfc_fc_dr1" target="_blank">
            <div className="circle  animate-pulse style={{ animationDelay: '12s' }} ">
              <Image
                src="https://m.media-amazon.com/images/M/MV5BNTVmZGJkOWUtNWJjNS00ZTNkLWFlMzQtZmQxOTkxZWE1MjAyXkEyXkFqcGdeQXVyNjc1ODAzODQ@._V1_.jpg"
                alt="Elizabeth Blake-Thomas Image"
                layout="responsive"
                width={250}
                height={250}
                title="Elizabeth Blake-Thomas."
              />
            </div>
          </a>
