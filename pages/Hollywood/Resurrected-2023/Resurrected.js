      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/Resurrected-2023/Resurrected",
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          property="og:title"
          content="Watch Resurrected (2023) | Uwatchfree™"
        />
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/Resurrected-2023/Resurrected"
        />
        <meta
          property="og:image"
          content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1688158914/Resurrected_2023_jbck9c.webp"
        />
        <meta
      ...
      <div className="bg-gray-600 shadow ">
        ...
        <h2
          ...
          style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
        >
          Listen to Audio Summary  Resurrected (2023)
        </h2>
        <div
