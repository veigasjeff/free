...
function BrooklynFortyFive({ movie }) {
  useEffect(() => {
  ...
  const ldJsonData = JSON.stringify({
    ...
    potentialAction: {
      ...
      target: [
        {
          "@type": "EntryPoint",
          name: "Brooklyn 45 (2023)",
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/Brooklyn45-2023/Watch-Movie-Brooklyn-FortyFive",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch Brooklyn 45 (2023) Full Movie Online Free | Uwatchfree™
        </title>
        <meta
          name="robots"
        ...
        <meta
          name="keywords"
          content="uwatchfree,brooklyn 45 movie,brooklyn 45 2023,index of brooklyn 45 movie,brooklyn 45 cast,brooklyn 45 trailer,brooklyn 45 release date,brooklyn 45 plot,brooklyn 45 reviews,brooklyn 45 streaming,brooklyn 45 watch online,brooklyn 45 download,brooklyn 45 full movie,brooklyn 45 movie download,brooklyn 45 movie free download,brooklyn 45 movie online,brooklyn 45 movie watch online"
        />
        ...
        <meta
          property="og:title"
          content="Watch Brooklyn 45 (2023) | Uwatchfree™"
        />
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/Brooklyn45-2023/Watch-Movie-Brooklyn-FortyFive"
        />
        <meta
          property="og:image"
          content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1686515472/Brooklyn-45-2023_szc11k.webp"
        />
        <meta
        ...
        <meta
          name="description"
          content="Watch Brooklyn 45 Full Movie Online on Uwatchfree™, You can also download Brooklyn 45 (2023) in full HD quality to watch later offline."
        />

        <link
          rel="canonical"
          href="https://uwatchfree.vercel.app/Hollywood/Brooklyn45-2023/"
        />
      </Head>
      ...
      <div className="bg-gray-600 shadow ">
        ...
        />
          <h2
            ...
            style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
          >
              Listen to Audio Summary The Movie Brooklyn 45 (2023)
          </h2>
  ...
  <audio controls preload="metadata" playsInline crossOrigin="anonymous" controlsList="nodownload">
    <source src="https://res.cloudinary.com/db36kfuq3/video/upload/v1687113761/bk_fvqiek.mp3" />
  </audio>
</div>
        <h1
          className="flex flex-col text-center py-5 font-bold text-3xl items-center justify-center"
...
export async function getServerSideProps() {
  ...
  const selectedMovie = data.find((movie) => movie.id === "INDEX80");
  return {
    props: {
      movie: selectedMovie,
    },
...
export default BrooklynFortyFive;
