...
function ThePerfectFind({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/PocketDialMurder-2023/Watch-Pocket-Dial-Murder-2023-Movie",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/PocketDialMurder-2023/Watch-Pocket-Dial-Murder-2023-Movie"
        />
        <meta
          property="og:image"
