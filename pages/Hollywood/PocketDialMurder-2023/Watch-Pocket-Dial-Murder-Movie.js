...
function ThePerfectFind({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Hollywood/PocketDialMurder-2023/Watch-Pocket-Dial-Murder-Movie",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Hollywood/PocketDialMurder-2023/Watch-Pocket-Dial-Murder-Movie"
        />
        <meta
          property="og:image"
