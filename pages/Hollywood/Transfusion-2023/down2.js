...
const down2 = () => {
  ...
  CLICK TO DOWNLOAD MOVIE TRANSFUSION 2023 LINK BELOW </h2>
  
  <Image className="scale-100 hover:scale-110 ease-in duration-500 cursor-pointer rounded-3xl blur-invert drop-shadowrounded-3xl" src='/transfusion-2023.webp' alt='TRANSFUSION - 2023' width={400} height={300}  loading="lazy"/>

<a href="https://dood.yt/d/x0qolw9rsi4y" target={"_blamk"} id="download_link" > 
...
<a href="../../Hollywood/Transfusion-2023/TRFSR2" > 
