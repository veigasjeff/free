  ...
  useEffect(() => {
    if (iframeRef) {
      ...
      iframe.addEventListener('load', function() {
        // Find the unmute button element within the iframe
        const unmuteButton = iframe.contentDocument.getElementById('unmute-button');
...
<div className={styles['iframe-container']}>
    <iframe    ref={iframeRef} className="video responsive rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 webkitAllowFullScreen mozallowfullscreen allowFullScreen" marginheight="0" marginwidth="0" src="https://daddylivehd.sx/embed/stream-31.php" name="iframe_a" scrolling="no" allowfullscreen="yes" width="100%" height="100%" frameborder="0"></iframe>
