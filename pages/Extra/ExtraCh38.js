...
const scrollSearExtraCh = myKey => {
  window.scrollTo(0, 0);
  frontMatter.handleSearExtraCh(myKey)
};
...
<link rel="apple-touExtraCh-icon" sizes="180x180" href="/apple-touExtraCh-icon.png" />
...
<WorldClock />
    <h1 className=" py-5 font-bold leading-none tracking-tight text-white  text-center text-3xl dark:text-white">
      Watch Sky Sports Main Event Live


  </h1>
    <div className="flex flex-col py-10 md-10  text-blue-600 text-center items-center justify-center">
    <Link href="/">
...
<div className={styles['iframe-container']}>
    <iframe className="video responsive rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 webkitallowFullScreen mozallowFullScreen allowFullScreen" marginHeight="0" marginWidth="0" src="https://daddylivehd.sx/extra-embed/stream-38.php" name="iframe_a" scrolling="no" allowFullScreen="yes" width="100%" height="100%" frameBorder="0"></iframe>
