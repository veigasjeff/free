...
const schemaData   = {
  ...
  "image": "https://uwatchfree.vercel.app/gulmohar-2023.webp",
...
<meta name="keywords" content="uwatchfree,full movie online free,HD movies,movie 2023,gulmohar movie,index of gulmohar movie,gulmohar movie 2023,gulmohar tv series,gulmohar movie online,watch gulmohar movie,dubbed movies,gulmohar movie download,gulmohar movie latest,gulmohar movie videos,gulmohar movie trailer,gulmohar movie cast,gulmohar movie story,gulmohar movie release date,gulmohar movie watch online free,gulmohar movie free download,gulmohar movie download" />
...
<meta property="og:image" content="https://uwatchfree.vercel.app/gulmohar-2023.webp" />
...
<meta name="twitter:image" content="https://uwatchfree.vercel.app/gulmohar-2023.webp" />
...
<link rel="canonical" href="https://uwatchfree.vercel.app/Bollywood/Gulmohar-2023/" />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white">Watch Gulmohar (2023) </h1>
   ...
   <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-2xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
    <a href="../Gulmohar-2023/Gulmohar" > 
      <h2 >Click To Watch Gulmohar (2023) Server 1</h2></a></button>
