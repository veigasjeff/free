...
function TikuWedsSheru ({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Bollywood/Tiku-Weds-Sheru-2023/Tiku-Weds-Sheru",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        <title>
          Watch Tiku Weds Sheru (2023) Full Movie Online Free | Uwatchfree™
        </title>
        <meta
          name="robots"
      ...
      <meta
        ...
        <meta
          property="og:title"
          content="Watch Tiku Weds Sheru (2023) | Uwatchfree™"
        />
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Bollywood/Tiku-Weds-Sheru-2023/Tiku-Weds-Sheru"
        />
        <meta
          property="og:image"
        ...
        <link
          rel="canonical"
          href="https://uwatchfree.vercel.app/Bollywood/Tiku-Weds-Sheru-2023/Tiku-Weds-Sheru"
        />
      </Head>
      ...
      <div className="bg-gray-600 shadow ">
        ...
        />
          <button className="relative inline-flex items-center animate-pulse rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110 cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
           <a href="../../Bollywood/Tiku-Weds-Sheru-2023/TWDS" >  
      ...
      <h3 className="mb-9 text-bg  text-black-500 text-blue-600 text-center xl:px-4 ">
        ...
        <h2
          ...
          style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
        >
          Listen to Audio Summary Tiku Weds Sheru (2023)
        </h2>
        <div
        ...
        >
          ...
          >
           <source src="https://ik.imagekit.io/gmcl6xvq6/Tiku_Weds_Sheru_-_Official_Trailer.mp4?updatedAt=1688791149102" />
          </audio>
        </div>
        ...
        >
          ...
          <a href="https://www.imdb.com/name/nm1596350/?ref_=ttfc_fc_cl_t1" target="_blank">
            <div className="circle">
              <Image
                src="https://in.bmscdn.com/iedb/artist/images/website/poster/large/nawazuddin_siddiqui_17110_26-07-2016_05-42-25.jpg"
                alt=" Nawazuddin Siddiqui Image"
                layout="responsive"
                width={250}
                height={250}
                title=" Nawazuddin Siddiqui."
              />
            </div></a>
            <a href="https://www.imdb.com/name/nm3941445/?ref_=ttfc_fc_cl_t2" target="_blank">
            <div className="circle">
              <Image
                src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi9Clk3PXTWDWc2V0BSgeiSC0IWF6ya_WaSUzZSq8-QjOJm37BoWU0_baanrKRQSTtLLMRc1KerxQ-WQCUiAHWAQTzmez7-tI9dcI8wJ6mGcPXWWuOBZ0X1EM1aLvHFFCfPPunz2rhgr59PWMKsqNhUAe2LZXMwX-JBhrBq0JPmLup2FF1XfWWSaE27pw/s1280/Avneet-Kaur-looks-cute-and-adorable-in-casual-outfit-See-the-pictures-01-Bengalplanet.com.jpg"
                alt=" Avneet Kaur Image"
                layout="responsive"
                width={250}
                height={250}
                title=" Avneet Kaur."
            ...
            <a href="https://www.imdb.com/name/nm12748124/?ref_=ttfc_fc_cl_t3" target="_blank">
            <div className="circle">
              <Image
            ...
            <a href="https://www.imdb.com/name/nm1201151/?ref_=ttfc_fc_cl_t4" target="_blank">
            <div className="circle">
              <Image
                src="https://i2.cinestaan.com/image-bank/1500-1500/76001-77000/76808.jpg"
                alt="Mukesh S. Bhatt Image"
                layout="responsive"
                width={250}
                height={250}
                title="Mukesh S. Bhatt."
              />
            </div></a>
            <a href="https://www.imdb.com/name/nm2286554/?ref_=ttfc_fc_cl_t5" target="_blank">
            <div className="circle">
              <Image
                src="https://in.bmscdn.com/iedb/artist/images/website/poster/large/suresh-vishwakarma-iein006051-03-10-2017-11-44-52.jpg"
                alt="Suresh Vishwakarma Image"
                layout="responsive"
                width={250}
                height={250}
                title="Suresh Vishwakarma."
              />
            </div></a>
          </div>
     ...
     <a href="https://www.imdb.com/name/nm3258929/?ref_=ttfc_fc_dr1">
          <div className="circle animate-pulse style={{ animationDelay: '12s' }}">
            <Image
              src="https://static.spotboye.com/uploads/sai-kabir_4ef7a5863ec2f60c6091d8fde24dba76_original.jpg"
              alt=" Sai Kabir Image"
              layout="responsive"
              width={250}
              height={250}
      ...
      {isHovered && (
        <div style={{ width: '200px', height: '200px', overflow: 'hidden', borderRadius: '50%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img
  ...
  />
          ...
          <h2
            ...
            style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
          >
            In the Movie Tiku Weds Sheru - 2023
          </h2>
