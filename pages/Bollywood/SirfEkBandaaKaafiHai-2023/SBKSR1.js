...
function SBKSR1({ movie }) {
  ...
  const ldJsonData = JSON.stringify({
    ...
    "potentialAction": {
      ...
      "target": [
        {
          "@type": "EntryPoint",
          "name": "Sirf Ek Bandaa Kaafi Hai (2023)",
          "urlTemplate": "https://uwatchfree.vercel.app/Bollywood/SirfEkBandaaKaafiHai-2023/SirfEkBandaaKaafiHai"
        },
        {
          "@type": "EntryPoint",
          "name": "Sirf Ek Bandaa Kaafi Hai (2023)",
          "urlTemplate": "https://uwatchfree.vercel.app/Bollywood/SirfEkBandaaKaafiHai-2023/SBKSR1"
        }
      ]
    },
    "aggregateRating": {
  ...
  return (
    <div>
      ...
      />
    <Head>
     <title>Watch Sirf Ek Bandaa Kaafi Hai (2023) Full Movie Online Free | Uwatchfree™</title>
<meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
<meta name="keywords" content="uwatchfree,sirf ek bandaa kaafi hai movie,sirf ek bandaa kaafi hai 2023,index of sirf ek bandaa kaafi hai movie,sirf ek bandaa kaafi hai cast,sirf ek bandaa kaafi hai trailer,sirf ek bandaa kaafi hai release date,sirf ek bandaa kaafi hai plot,sirf ek bandaa kaafi hai reviews,sirf ek bandaa kaafi hai streaming,sirf ek bandaa kaafi hai watch online,sirf ek bandaa kaafi hai download,sirf ek bandaa kaafi hai full movie,sirf ek bandaa kaafi hai movie download,sirf ek bandaa kaafi hai movie free download,sirf ek bandaa kaafi hai movie online,sirf ek bandaa kaafi hai movie watch online" />
...
<meta property="og:title" content="Watch Sirf Ek Bandaa Kaafi Hai (2023) | Uwatchfree™" />
<meta property="og:url" content="https://uwatchfree.vercel.app/Bollywood/SirfEkBandaaKaafiHai-2023/SirfEkBandaaKaafiHai" />
<meta property="og:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1685262881/Sirf_Ek_Bandaa_Kaafi_Hai_2023_ye9acd.webp" />
<meta property="og:image:secure_url" content="https://uwatchfree.vercel.app/" />
<meta property="og:image:width" content="1280" />
<meta property="og:image:height" content="720" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:title" content="Watch Sirf Ek Bandaa Kaafi Hai (2023) | Uwatchfree™" />
...
<link rel="canonical" href="https://uwatchfree.vercel.app/Bollywood/SirfEkBandaaKaafiHai-2023/SBKSR1" />
       </Head>
...
<ShareButtons url="https://uwatchfree.vercel.app" title="Watch Movies, TV-Series & Sports Live Online Free" image="https://uwatchfree.vercel.app/og_image.jpg" />
           ...
           <a href="../SirfEkBandaaKaafiHai-2023/SirfEkBandaaKaafiHai" >  
    ...
    <ul className="flex container flex-col items-center justify-center space-y-3 text-xl font-bold text-center text-white"style={{ textShadow: "0px 0px 2px #000" }}>
      ...
      <h2 className="flex container flex-col items-center justify-center space-y-3 text-3xl font-bold text-center text-text-white"style={{ textShadow: "0px 0px 2px #000" }}>In the movie Sirf Ek Bandaa Kaafi Hai (2023)</h2>
