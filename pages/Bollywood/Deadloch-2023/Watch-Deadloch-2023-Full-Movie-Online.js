      ...
      target: [
        {
          ...
          name: "Deadloch (2023) ",
          urlTemplate:
            "https://uwatchfree.vercel.app/Bollywood/Deadloch-2023/Watch-Deadloch-2023-Full-Movie-Online",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Bollywood/Deadloch-2023/Watch-Deadloch-2023-Full-Movie-Online"
        />
        <meta
          property="og:image"
      ...
      <div className="bg-gray-600 shadow ">
        ...
        >
          ...
          <h2
            ...
            style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
          >
            In the TV Series Deadloch (2023)
          </h2>
