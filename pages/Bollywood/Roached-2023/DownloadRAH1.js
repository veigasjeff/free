...
function DownloadRAH1({ movie }) {
      ...
      "target": [
        {
          "@type": "EntryPoint",
          "name": "Roached (2023)",
          "urlTemplate": "https://uwatchfree.vercel.app/Bollywood/Roached-2023/Roached"
        },
        {
          "@type": "EntryPoint",
          "name": "Roached (2023)",
          "urlTemplate": "https://uwatchfree.vercel.app/Bollywood/Roached-2023/RAHSR1"
        }
      ]
    },
    "aggregateRating": {
  ...
  return (
    <div>
      ...
      />
    <Head>
     <title>Watch Roached (2023) Full Movie Online Free | Uwatchfree™</title>
...
<meta property="og:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610090/roached-2023_n2qyxx.webp" />
...
<meta name="twitter:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610090/roached-2023_n2qyxx.webp" />
...
<a href="../../Bollywood/Roached-2023/Roached" >
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0  ">
  Back
