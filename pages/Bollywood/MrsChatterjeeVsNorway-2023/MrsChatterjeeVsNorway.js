...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatchfree.vercel.app/Bollywood/MrsChatterjeeVsNorway-2023/MrsChatterjeeVsNorway"
    
  },
  "headline": "Mrs Chatterjee Vs Norway (2023) Full Movie Online Free | Uwatchfree™",
  "image": "https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610083/mrs-chatterjee-vs-norway-2023_nkuori.webp",
  ...
  "description": "Uwatchfree™ Mrs Chatterjee Vs Norway (2023) Full Movie Online Free | Watch Movies, TV-Series & Sports Live Online Free"
...
<meta property="og:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610083/mrs-chatterjee-vs-norway-2023_nkuori.webp" />
<meta property="og:image:secure_url" content="https://uwatchfree.vercel.app/" />
<meta property="og:image:width" content="1280" />
<meta property="og:image:height" content="720" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:title" content="Watch Mrs Chatterjee Vs Norway (2023) | Uwatchfree™" />
<meta name="twitter:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610083/mrs-chatterjee-vs-norway-2023_nkuori.webp" />
<meta name="description" content="Watch Mrs Chatterjee Vs Norway Full Movie Online on Uwatchfree™, You can also download Mrs Chatterjee Vs Norway (2023) in full HD quality to watch later offline." />

<link rel="canonical" href="https://uwatchfree.vercel.app/Bollywood/MrsChatterjeeVsNorway-2023/MrsChatterjeeVsNorway" />
...
<Script src="../../propler/ads.js" defer />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white"  style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>Watch Mrs Chatterjee Vs Norway (2023) </h1>

    <div className={styles['iframe-container']}>
      <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://sbface.com/e/zc7puei0enit.html" />
    </div>     
...
<ShareButtons url="https://uwatchfree.vercel.app" title="Watch Movies, TV-Series & Sports Live Online Free" image="https://uwatchfree.vercel.app/og_image.jpg" />
   ...
   <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
    <a href="../MrsChatterjeeVsNorway-2023/CVNSR2" > 
      <h2 > Watch Mrs Chatterjee Vs Norway (2023) Server 2</h2></a></button>
...
<div>
    ...
    <a href="https://www.imdb.com/title/tt14295590/" target="_blank" > 
...
<h2 ><strong>Genre:</strong> Biography, Drama, Family </h2>
<h2 ><strong>Release year:</strong> 2023</h2>
<h2 ><strong>Director:</strong>Ashima Chibber</h2>
<h2 ><strong>Country:</strong> India</h2>
<h2 ><strong>Starring:</strong> Rani Mukerji, Jim Sarbh, Neena Gupta, Sara Soulié, Charu Shankar, Anirban Bhattacharya, 	Tiina Tauraite, Kristjan Üksküla, Erki Laur, Soumya Mukherjee, Barun Chanda, Carol Tamm, 	Jason E. Medina.</h2>
<h2 ><strong>Description:</strong> An immigrant Indian mother's battle against the Norwegian foster care system and local legal machinery to win back the custody of her children.</h2>
</div>
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 "  onClick={togglePopup} >
        ...
        <div className="popup-overlay">
         ...
         <div className="popup ">
          ...
          <h2 className="text-2xl font-bold" >Offical Trailer Mrs Chatterjee Vs Norway (2023) </h2>
           <div className={styles['iframe-container']}>
 <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://sbface.com/e/twbxjz61z0ss.html" />
 ...
 <h3  className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">Mrs Chatterjee Vs Norway (2023) </h3>
 <Link href="../../Bollywood/MrsChatterjeeVsNorway-2023/DownloadCVN1">
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
Download 
...
<h3 className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">Mrs Chatterjee Vs Norway (2023)</h3>
<Link href="../../Bollywood/MrsChatterjeeVsNorway-2023/DownloadCVN2">
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
Download 
...
export default MrsChatterjeeVsNorway ;