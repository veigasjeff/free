    ...
    "episode": [
      {
        ...
        "url": "https://uwatchfree.vercel.app/Bollywood/JubileeS01-2023/JUBSR1"
      },
      {
        "@type": "TVEpisode",
        "name": "Jubilee S01 Episode 2",
        "url": "https://uwatchfree.vercel.app/Bollywood/JubileeS01-2023/JUBSR2"
      },
      {
        "@type": "TVEpisode",
        "name": "Jubilee S01 Episode 3",
        "url": "https://uwatchfree.vercel.app/Bollywood/JubileeS01-2023/JUBSR3"
      },
      {
        "@type": "TVEpisode",
        "name": "Jubilee S01 Episode 4",
        "url": "https://uwatchfree.vercel.app/Bollywood/JubileeS01-2023/JUBSR4"
      },
      {
        "@type": "TVEpisode",
        "name": "Jubilee S01 Episode 5",
        "url": "https://uwatchfree.vercel.app/Bollywood/JubileeS01-2023/JUBSR5"
      },
      {
        "@type": "TVEpisode",
        "name": "Jubilee S01 Episode 6",
        "url": "https://uwatchfree.vercel.app/Bollywood/JubileeS01-2023/JUBSR6"
      },
      {
        "@type": "TVEpisode",
        "name": "Jubilee S01 Episode 7",
        "url": "https://uwatchfree.vercel.app/Bollywood/JubileeS01-2023/JUBSR7"
      },
      {
        "@type": "TVEpisode",
        "name": "Jubilee S01 Episode 8",
        "url": "https://uwatchfree.vercel.app/Bollywood/JubileeS01-2023/JUBSR8"
      },
      {
        "@type": "TVEpisode",
        "name": "Jubilee S01 Episode 9",
        "url": "https://uwatchfree.vercel.app/Bollywood/JubileeS01-2023/JUBSR9"
      },
      {
        "@type": "TVEpisode",
        "name": "Jubilee S01 Episode 10",
        "url": "https://uwatchfree.vercel.app/Bollywood/JubileeS01-2023/JUBSR10"
      }
    ],
    "author": [{
      "@type": "Person",
...
<meta name="keywords" content="uwatchfree,watch free movies,full movie online free,hd movies,movie 2023,latest movie,dubbed movies,free movie download,watch jubilee s01 movie,index of jubilee s01 movie,jubilee s01 movie 2023,jubilee s01 movie online,watch jubilee s01 movie online free,jubilee s01 tv series,jubilee s01 movie download,jubilee s01 movie free download,jubilee s01 movie download" />
...
<meta property="og:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681682712/jubilee-2023_nfn3yw.webp" />
...
<link rel="canonical" href="https://uwatchfree.vercel.app/Bollywood/JubileeS01-2023/JUBSR1" /> 
       </Head>
...
<ShareButtons url="https://uwatchfree.vercel.app" title="Watch Movies, TV-Series & Sports Live Online Free" image="https://uwatchfree.vercel.app/og_image.jpg" />
    ...
    <Link href="../../Bollywood/JubileeS01-2023/JUBSR1">
  ...
  Episode 1
    ...
    <div className="flex justify-center">
    <Link href="../../Bollywood/JubileeS01-2023/JUBSR2">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dJUB:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dJUB:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dJUB:bg-gray-900 group-hover:bg-opacity-0 ">
  Episode 2
      </button></Link>
    </div>
    <div className="flex justify-center">
    <Link href="../../Bollywood/JubileeS01-2023/JUBSR3">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dJUB:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dJUB:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dJUB:bg-gray-900 group-hover:bg-opacity-0 ">
  Episode 3
      </button></Link>
      </div>
      <div className="flex justify-center">
      <Link href="../../Bollywood/JubileeS01-2023/JUBSR4">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dJUB:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dJUB:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dJUB:bg-gray-900 group-hover:bg-opacity-0 ">
  Episode 4
      </button></Link>
      </div>
      <div className="flex justify-center">
      <Link href="../../Bollywood/JubileeS01-2023/JUBSR5">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dJUB:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dJUB:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dJUB:bg-gray-900 group-hover:bg-opacity-0 ">
  Episode 5
      </button></Link>
      </div>
      <div className="flex justify-center">
      <Link href="../../Bollywood/JubileeS01-2023/JUBSR6">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dJUB:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dJUB:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dJUB:bg-gray-900 group-hover:bg-opacity-0 ">
  Episode 6
      </button></Link>
      </div>
      <div className="flex justify-center">
      <Link href="../../Bollywood/JubileeS01-2023/JUBSR7">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dJUB:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dJUB:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dJUB:bg-gray-900 group-hover:bg-opacity-0 ">
  Episode 7
      </button></Link>
      </div>
      <div className="flex justify-center">
      <Link href="../../Bollywood/JubileeS01-2023/JUBSR8">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dJUB:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dJUB:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dJUB:bg-gray-900 group-hover:bg-opacity-0 ">
  Episode 8
      </button></Link>
      </div>
      <div className="flex justify-center">
      <Link href="../../Bollywood/JubileeS01-2023/JUBSR9">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dJUB:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dJUB:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dJUB:bg-gray-900 group-hover:bg-opacity-0 ">
  Episode 9
      </button></Link>
      </div>
  ...
  Episode 10
           ...
           <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dJUB:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dJUB:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dJUB:bg-gray-900 group-hover:bg-opacity-0 ">
           <a href="../JubileeS01-2023/JubileeP6" >  
      <h2 > Watch {movie.name} (2023) Server 1</h2></a></button>
      <Rating />
      <a href={movie.link} className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dJUB:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dJUB:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dJUB:bg-gray-900 group-hover:bg-opacity-0 " JUBget="_blank">IMDb Rating: {movie.rating}</a>  
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dJUB:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dJUB:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dJUB:bg-gray-900 group-hover:bg-opacity-0 "  onClick={togglePopup} >
        ...
        <div className="popup-overlay">
         ...
         <div className="popup ">
               ...
               <h2 className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dJUB:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dJUB:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dJUB:bg-gray-900 group-hover:bg-opacity-0 " >  Close</h2>  
          </button>
