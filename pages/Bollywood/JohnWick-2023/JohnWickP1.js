...
function JohnWickP1({ movie }) {
  ...
  const schemaData   = {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://uwatchfree.vercel.app/Bollywood/JohnWick-2023/JohnWickP1"
      
    },
    "headline": "John Wick Series (2023) Full Movie Online Free | Uwatchfree™",
    "image": "https://uwatchfree.vercel.app/john-wick-c4-2023.webp",
    ...
    "description": "Uwatchfree™ John Wick Series (2023) Full Movie Online Free | Watch Movies, TV-Series & Sports Live Online Free"
...
<meta name="keywords" content="uwatchfree,watch free movies,full movie online free,hd movies,movie 2023,latest movie,dubbed movies,free movie download,watch JohnWick movie,index of JohnWick movie,JohnWick movie 2023,JohnWick movie online,watch JohnWick movie online free,JohnWick tv series,JohnWick movie download,JohnWick movie free download,JohnWick movie download" />
...
<meta property="og:title" content="Watch John Wick Series (2023) | Uwatchfree™" />
<meta property="og:url" content="https://uwatchfree.vercel.app/Bollywood/JohnWick-2023/JohnWickP1" />
<meta property="og:image" content="https://uwatchfree.vercel.app/john-wick-c4-2023.webp" />
<meta property="og:image:secure_url" content="https://uwatchfree.vercel.app/" />
<meta property="og:image:width" content="1280" />
<meta property="og:image:height" content="720" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:title" content="Watch John Wick Series (2023) | Uwatchfree™" />
...
<link rel="canonical" href="https://uwatchfree.vercel.app/Bollywood/JohnWick-2023/" />
       ...
       <h1 className="flex flex-col text-center py-5 font-bold text-3xl items-center justify-center" style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>{movie.title} CHAPTER 4</h1>
    ...
    <Link href="../../Bollywood/JohnWick-2023/JohnWickP1">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
  Chapter 4 (2023) 
      </button></Link>
    </div>
    <div className="flex justify-center">
    <Link href="../../Bollywood/JohnWick-2023/JohnWickP2">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
  Chapter 3 (2019)
      </button></Link>
    </div>
    <div className="flex justify-center">
    <Link href="../../Bollywood/JohnWick-2023/JohnWickP3">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
  Chapter 2 (2017)
      </button></Link>
      </div>
      <div className="flex justify-center">
      <Link href="../../Bollywood/JohnWick-2023/JohnWickP4">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
  Chapter 1 (2014) 
      </button></Link>
      </div>
...
export async function getServerSideProps() {
  ...
  const selectedMovie = data.find(movie => movie.id === 'JHW');
  return {
    props: {
      movie: selectedMovie
    }
