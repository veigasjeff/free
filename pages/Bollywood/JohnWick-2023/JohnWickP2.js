...
function JohnWickP2({ movie }) {
  ...
  const schemaData   = {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://uwatchfree.vercel.app/Bollywood/JohnWick-2023/JohnWickP2"
...
<meta property="og:url" content="https://uwatchfree.vercel.app/Bollywood/JohnWick-2023/JohnWickP2" />
...
<link rel="canonical" href="https://uwatchfree.vercel.app/Bollywood/JohnWick-2023/" />
       ...
       <h1 className="flex flex-col text-center py-5 font-bold text-3xl items-center justify-center" style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>{movie.title} CHAPTER 3</h1>
