...
function BloodyDaddy({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Bollywood/BloodyDaddy-2023/Bloody-Daddy",
  ...
  return (
    ...
    <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Bollywood/BloodyDaddy-2023/Bloody-Daddy"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch Bloody Daddy Full Movie Online on Uwatchfree™, You can also Watch Now Or Download To Watch Later!"
        />
      ...
      <h2 > Change Server {movie.name}   </h2></a></button>
        ...
        <h2
          ...
          style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
        >
          Listen to Audio Summary  Bloody Daddy (2023)
        </h2>
        <div
