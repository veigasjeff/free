...
function MaukaYaDhoka({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Bollywood/MaukaYaDhoka-2023/Watch-Mauka-Ya-Dhoka-Movie",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Bollywood/MaukaYaDhoka-2023/Watch-Mauka-Ya-Dhoka-Movie"
        />
        <meta
          property="og:image"
