...
function MaukaYaDhoka({ movie }) {
  ...
  return (
    ...
    <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Bollywood/MaukaYaDhoka-2023/MaukaYaDhoka"
        />
        <meta
          property="og:image"
      ...
      <div className="bg-gray-600 shadow ">
        ...
        />
           ...
           <a href="../../Bollywood/MaukaYaDhoka-2023/MYAD" >  
      <h2 > Change Server {movie.name}   </h2></a>  </button>
        <h2
          ...
          style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
        >
          Listen to Audio Summary  Mauka Ya Dhoka (2023)
        </h2>
        <div
