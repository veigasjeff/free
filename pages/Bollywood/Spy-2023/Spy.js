...
function Spy ({ movie }) {
      ...
      target: [
        {
          ...
          name: " Spy (2023)",
          urlTemplate:
            "https://uwatchfree.vercel.app/Bollywood/Spy-2023/Spy",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        <title>
          Watch  Spy (2023) Full Movie Online Free | Uwatchfree™
        </title>
        <meta
          name="robots"
      ...
      <meta
        ...
        <meta
          property="og:title"
          content="Watch Spy (2023) | Uwatchfree™"
        />
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Bollywood/Spy-2023/Spy"
        />
        <meta
          property="og:image"
        ...
        <link
          rel="canonical"
          href="https://uwatchfree.vercel.app/Bollywood/Spy-2023/Spy"
        />
      </Head>
      ...
      <div className="bg-gray-600 shadow ">
        ...
        />
          <button className="relative inline-flex items-center animate-pulse rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110 cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
           <a href="../../Bollywood/Spy-2023/SPY1" >  
      ...
      <h3 className="mb-9 text-bg  text-black-500 text-blue-600 text-center xl:px-4 ">
        ...
        <h2
          ...
          style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
        >
          Listen to Audio Summary Spy (2023)
        </h2>
        <div
        ...
        >
          ...
          >
           <source src="https://ik.imagekit.io/gmcl6xvq6/Spy_official_trailer-2023.mp4?updatedAt=1689014796021" />
          </audio>
        </div>
        ...
        >
          ...
          <a href="https://www.imdb.com/name/nm2981266/?ref_=ttfc_fc_cl_t1" target="_blank">
            <div className="circle">
              <Image
                src="https://cdn.filmytoday.com/attachments/albums/dps/1452.jpg"
                alt="Nikhil Siddharth Image"
                layout="responsive"
                width={250}
                height={250}
                title="Nikhil Siddharth."
              />
            </div></a>
            <a href="https://www.imdb.com/name/nm5719512/?ref_=ttfc_fc_cl_t2" target="_blank">
            <div className="circle">
              <Image
                src="https://www.filmibeat.com/img/315x100x396/popcorn/profile_photos/iswarya-menon-20210524162004-35375.jpg"
                alt=" Iswarya Menon Image"
                layout="responsive"
                width={250}
                height={250}
                title=" Iswarya Menon."
            ...
            <a href="https://www.imdb.com/name/nm2331736/?ref_=ttfc_fc_cl_t3" target="_blank">
            <div className="circle">
              <Image
                src="https://cdn.filmytoday.com/attachments/albums/dps/3688.jpg"
                alt=" Aryan Rajesh Image"
                layout="responsive"
                width={250}
                height={250}
                title=" Aryan Rajesh."
            ...
            <a href="https://www.imdb.com/name/nm5118890/?ref_=ttfc_fc_cl_t4" target="_blank">
            <div className="circle">
              <Image
                src="https://in.bmscdn.com/iedb/artist/images/website/poster/large/abhinav-gomatam-1050237-1686311975.jpg"
                alt="Abhinav Gomatam Image"
                layout="responsive"
                width={250}
                height={250}
                title="Abhinav Gomatam."
              />
            </div></a>
            <a href="https://www.imdb.com/name/nm13480200/?ref_=ttfc_fc_cl_t5" target="_blank">
            <div className="circle">
              <Image
                src="https://wikibio.in/wp-content/uploads/2023/06/Sanya-Thakur.jpg"
                alt="Sanya Thakur Image"
                layout="responsive"
                width={250}
                height={250}
                title="Sanya Thakur."
     ...
     <a href="https://www.imdb.com/name/nm9492020/?ref_=ttfc_fc_dr1">
          <div className="circle animate-pulse style={{ animationDelay: '12s' }}">
            <Image
              src="https://in.bmscdn.com/iedb/artist/images/website/poster/large/garry-bh-1262298-1686313395.jpg"
              alt=" Garry Bh Image"
              layout="responsive"
              width={250}
              height={250}
  ...
  <img
    src="https://play-lh.googleusercontent.com/yZ5ueNSQRSfta11I2SRRLUaw3NAikkVYO5b6-8p2kYFtWmfz-350IWDmhIV74r460Q" // Replace with the actual path or URL of the image
    alt="Red Cinemas Image"
