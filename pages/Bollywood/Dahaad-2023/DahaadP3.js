...
function DahaadP2({ movie }) {
    ...
    "Part": [
      {
        "@type": "TVPart",
        "name": "Dahaad Part 1",
        "url": "https://uwatchfree.vercel.app/Bollywood/Dahaad-2023/DahaadP1"
      },
      {
        "@type": "TVPart",
        "name": "Dahaad Part 2",
        "url": "https://uwatchfree.vercel.app/Bollywood/Dahaad-2023/DahaadP2"
      },
      {
        "@type": "TVPart",
        "name": "Dahaad Part 3",
        "url": "https://uwatchfree.vercel.app/Bollywood/Dahaad-2023/DahaadP3"
      },
    ],
    "author": [{
      "@type": "Person",
  ...
  "publisher": {
    ...
    potentialAction: {
      ...
      target: {
        "@type": "EntryPoint",
        urlTemplate:
          "https://uwatchfree.vercel.app/Bollywood/Dahaad-2023/DahaadP1",
      },
    },
    "additionalProperty": {
      "@type": "PropertyValue",
  ...
  return (
    <div>
      ...
      />
    <Head>
     <title>Watch Dahaad (2023) Full Movie Online Free | Uwatchfree™</title>
<meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
<meta name="keywords" content="uwatchfree,dahaad tv series,dahaad 2023,index of dahaad tv series,dahaad cast,dahaad trailer,dahaad release date,dahaad plot,dahaad reviews,dahaad streaming,dahaad watch online,dahaad download,dahaad full Parts,dahaad tv series download,dahaad tv series free download,dahaad tv series online,dahaad tv series watch online" />
...
<meta property="og:title" content="Watch Dahaad (2023) | Uwatchfree™" />
<meta property="og:url" content="https://uwatchfree.vercel.app/Bollywood/Dahaad-2023/DahaadP1" />
<meta property="og:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1683907527/Dahaad-S01-2023_icbq9u.webp" />
<meta property="og:image:secure_url" content="https://uwatchfree.vercel.app/" />
<meta property="og:image:width" content="1280" />
<meta property="og:image:height" content="720" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:title" content="Watch Dahaad (2023) | Uwatchfree™" />
<meta name="twitter:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1683907527/Dahaad-S01-2023_icbq9u.webp" />
<meta name="description" content="Watch Dahaad Full Movie Online on Uwatchfree™, You can also download Dahaad (2023) in full HD quality to watch later offline." />

<link rel="canonical" href="https://uwatchfree.vercel.app/Bollywood/Dahaad-2023/" />
...
<div className="grid grid-cols-1 mx-20 sm:grid-cols-2  x:grid-cols-3 gap-4">
    ...
    <Link href="../../Bollywood/Dahaad-2023/DahaadP1">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
  Part 1
      </button></Link>
    </div>
    <div className="flex justify-center">
    <Link href="../../Bollywood/Dahaad-2023/DahaadP2">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
  Part 2
      </button></Link>
    </div>
    <div className="flex justify-center">
    <Link href="../../Bollywood/Dahaad-2023/DahaadP3">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
  Part 3
      </button></Link>
    </div>
...
export async function getServerSideProps() {
  ...
  const selectedMovie = data.find(movie => movie.id === 'DHD');
  return {
    props: {
      movie: selectedMovie
    }
