...
function Neeyat ({ movie }) {
      ...
      target: [
        {
          ...
          name: " Neeyat (2023)",
          urlTemplate:
            "https://uwatchfree.vercel.app/Bollywood/Neeyat-2023/NEYT",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        <title>
          Watch  Neeyat (2023) Full Movie Online Free | Uwatchfree™
        </title>
        <meta
          name="robots"
      ...
      <meta
        ...
        <meta
          property="og:title"
          content="Watch Neeyat (2023) | Uwatchfree™"
        />
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Bollywood/Neeyat-2023/NEYT"
        />
        <meta
          property="og:image"
        ...
        <link
          rel="canonical"
          href="https://uwatchfree.vercel.app/Bollywood/Neeyat-2023/Neeyat"
        />
      </Head>
      ...
      <div className="bg-gray-600 shadow ">
        ...
        />
          <button className="relative inline-flex items-center animate-pulse rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110 cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
           <a href="../../Bollywood/Neeyat-2023/Neeyat" >  
      ...
      <h3 className="mb-9 text-bg  text-black-500 text-blue-600 text-center xl:px-4 ">
        ...
        <h2
          ...
          style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
        >
          Listen to Audio Summary Neeyat (2023)
        </h2>
        <div
        ...
        >
          ...
          >
           <source src="https://ik.imagekit.io/gmcl6xvq6/Neeyat_-_Official_Trailer.mp4?updatedAt=1688789629477" />
          </audio>
        </div>
        ...
        >
          ...
          <a href="https://www.imdb.com/name/nm1799038/?ref_=ttfc_fc_cl_t1" target="_blank">
            <div className="circle">
              <Image
                src="https://static.joonsite.com/seelatest/topic/vidya-balan.jpg"
            ...
            <div className="circle">
              <Image
                src="https://qt.azureedge.net/resources/authors-images-large/ram-kapoor.jpg"
                alt=" Ram Kapoor Image"
                layout="responsive"
                width={250}
                height={250}
                title=" Ram Kapoor."
            ...
            <a href="https://www.imdb.com/name/nm0097893/?ref_=ttfc_fc_cl_t3" target="_blank">
            <div className="circle">
              <Image
                src="https://static.joonsite.com/seelatest/topic/rahul-bose.jpg"
                alt=" Rahul Bose Image"
                layout="responsive"
                width={250}
                height={250}
                title=" Rahul Bose."
            ...
            <a href="https://www.imdb.com/name/nm2257218/?ref_=ttfc_fc_cl_t4" target="_blank">
            <div className="circle">
              <Image
                src="https://www.nowrunning.com/content/Artist/ShahanaGoswami/banner.jpg"
                alt="Shahana Goswami Image"
                layout="responsive"
                width={250}
                height={250}
            ...
            <a href="https://www.imdb.com/name/nm4173131/?ref_=ttfc_fc_cl_t5" target="_blank">
            <div className="circle">
              <Image
                src="https://nettv4u.com/imagine/n/e/e/r/a/j/neeraj-kabi.jpg"
                alt="Neeraj Kabi Image"
                layout="responsive"
                width={250}
                height={250}
                title="Neeraj Kabi."
     ...
     <a href="https://www.imdb.com/name/nm7278299/?ref_=ttfc_fc_dr1">
          <div className="circle animate-pulse style={{ animationDelay: '12s' }}">
            <Image
              src="https://in.bmscdn.com/iedb/artist/images/website/poster/large/anu-menon-1070020-24-03-2017-13-06-51.jpg"
              alt=" Anu Menon Image"
              layout="responsive"
              width={250}
              height={250}
  ...
  <img
    src="https://penindia.in/wp-content/uploads/2020/03/PM-with-Bg-for-wesite-1.jpg" // Replace with the actual path or URL of the image
    alt="pen india Image"
