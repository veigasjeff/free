...
function Blind ({ movie }) {
      ...
      target: [
        {
          ...
          name: " Blind (2023)",
          urlTemplate:
            "https://uwatchfree.vercel.app/Bollywood/Blind-2023/Blind",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    ...
    <Head>
        <title>
          Watch  Blind (2023) Full Movie Online Free | Uwatchfree™
        </title>
        <meta
          name="robots"
      ...
      <meta
        ...
        <meta
          property="og:title"
          content="Watch Blind (2023) | Uwatchfree™"
        />
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Bollywood/Blind-2023/Blind"
        />
        <meta
          property="og:image"
        ...
        <link
          rel="canonical"
          href="https://uwatchfree.vercel.app/Bollywood/Blind-2023/Blind"
        />
      </Head>
      ...
      <div className="bg-gray-600 shadow ">
        ...
        />
          <button className="relative inline-flex items-center animate-pulse rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110 cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
           <a href="../../Bollywood/Blind-2023/BLND" >  
      ...
      <h3 className="mb-9 text-bg  text-black-500 text-blue-600 text-center xl:px-4 ">
        ...
        <h2
          ...
          style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
        >
          Listen to Audio Summary Blind (2023)
        </h2>
        <div
        ...
        >
          ...
          >
           <source src="https://ik.imagekit.io/gmcl6xvq6/Blind_-_Official_Trailer.mp4?updatedAt=1688789628094" />
          </audio>
        </div>
        ...
        >
          ...
          <a href="https://www.imdb.com/name/nm2128238/?ref_=ttfc_fc_cl_t2" target="_blank">
            <div className="circle">
              <Image
                src="https://nettv4u.com/imagine/29-07-2017/sonam-kapoor.jpg"
                alt="Sonam Kapoor Image"
                layout="responsive"
                width={250}
                height={250}
                title="Sonam Kapoor."
            ...
            <a href="https://www.imdb.com/name/nm5890145/?ref_=ttfc_fc_cl_t1" target="_blank">
            <div className="circle">
              <Image
                src="https://images.mubicdn.net/images/cast_member/575036/cache-320341-1521088597/image-w856.jpg?size=800x"
                alt=" Lucy Aarden Image"
                layout="responsive"
                width={250}
                height={250}
                title=" Lucy Aarden."
            ...
            <a href="https://www.imdb.com/name/nm0239267/?ref_=ttfc_fc_cl_t3" target="_blank">
            <div className="circle">
              <Image
                src="https://assets-in.bmscdn.com/iedb/artist/images/website/poster/large/lillete-dubey-3727-24-03-2017-15-46-22.jpg"
                alt=" Lillete Dubey Image"
                layout="responsive"
                width={250}
                height={250}
                title=" Lillete Dubey."
            ...
            <a href="https://www.imdb.com/name/nm4788100/?ref_=ttfc_fc_cl_t4" target="_blank">
            <div className="circle">
              <Image
                src="https://ntvb.tmsimg.com/assets/assets/742271_v9_ba.jpg?w=270&h=360"
                alt="Shubham Saraf Image"
                layout="responsive"
                width={250}
                height={250}
                title="Shubham Saraf."
            ...
            <a href="https://www.imdb.com/name/nm1327322/?ref_=ttfc_fc_cl_t5" target="_blank">
            <div className="circle">
              <Image
                src="https://assets-in.bmscdn.com/iedb/artist/images/website/poster/large/purab-kohli-1744-24-03-2017-12-34-53.jpg"
                alt="Purab Kohli Image"
                layout="responsive"
                width={250}
                height={250}
                title="Purab Kohli."
     ...
     <a href="https://www.imdb.com/name/nm3019501/?ref_=ttfc_fc_dr1">
          <div className="circle animate-pulse style={{ animationDelay: '12s' }}">
            <Image
              src="https://nettv4u.com/serialimages/30-08-2019/shome-makhija.jpg"
              alt=" Shome Makhija Image"
              layout="responsive"
              width={250}
              height={250}
              title=" Shome Makhija."
  ...
  <img
    src="https://v3img.voot.com/v3Storage/assets/jc_logo_stack-1682163295957.jpg" // Replace with the actual path or URL of the image
