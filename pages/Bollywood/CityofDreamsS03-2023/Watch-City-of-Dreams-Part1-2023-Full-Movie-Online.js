      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Bollywood/CityofDreamsS03-2023/Watch-City-of-Dreams-Part1-2023-Full-Movie-Online",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Bollywood/CityofDreamsS03-2023/Watch-City-of-Dreams-Part1-2023-Full-Movie-Online"
        />
        <meta
          property="og:image"
      ...
      <div className="bg-gray-600 shadow ">
        ...
        >
          City of Dreams S03 Part 1 - 2023
        </h1>
        ...
        <div className="flex justify-center">
          <Link href="../../Bollywood/CityofDreamsS03-2023/Watch-City-of-Dreams-Part2-2023-Full-Movie-Online">
        ...
        >
          ...
          <h2
            ...
            style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
          >
            In the movie City of Dreams (2023)
          </h2>
        ...
        <div className="flex flex-col py-10  text-blue-600 text-center items-center justify-center">
          ...
          <a href={movie.down12ink1} target="_blank">
            <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110 cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
              Download Part 1
            </button>
          </a>
