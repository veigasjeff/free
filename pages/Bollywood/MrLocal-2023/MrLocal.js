...
const schemaData   = {
  ...
  "image": "https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610083/mr-local-2023_ypio3h.webp",
  ...
  "description": "Uwatchfree™ Mr Local (2023) Full Movie Online Free | Watch Movies, TV-Series & Sports Live Online Free"
...
<meta name="keywords" content="uwatchfree,watch free movies,full movie online free,hd movies,movie 2023,latest movie,dubbed movies,free movie download,watch mr local movie,index of mr local movie,mr local movie 2023,mr local movie online,watch mr local movie online free,mr local tv series,mr local movie download,mr local movie free download,mr local movie download" />
...
<meta property="og:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610083/mr-local-2023_ypio3h.webp" />
...
<meta name="twitter:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610083/mr-local-2023_ypio3h.webp" />
...
<Script src="../../propler/ads.js" defer />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white"  style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>Watch Mr Local (2023) </h1>

    <div className={styles['iframe-container']}>
      <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://sbbrisk.com/e/jrkm6vmdypza.html" />
    </div>    
...
<ShareButtons url="https://uwatchfree.vercel.app" title="Watch Movies, TV-Series & Sports Live Online Free" image="https://uwatchfree.vercel.app/og_image.jpg" />
   ...
   <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
    <a href="../MrLocal-2023/MLOSR2" > 
      <h2 > Watch Mr Local (2023) Server 2</h2></a></button>
...
<div>
    ...
    <a href="https://www.imdb.com/title/tt9053416/" target="_blank"  > 
...
<h2 ><strong>Director:</strong>M. Rajesh</h2>
<h2 ><strong>Country:</strong> India</h2>
<h2 ><strong>Starring:</strong> Sivakarthikeyan, Nayanthara, Thambi Ramaiah, Yogi Babu, Robo Shankar, Raadhika Sarathkumar.</h2>
<h2 ><strong>Description:</strong>The film revolves around a carefree "local" guy, Manohar, who leads a happy life with his mother and sister. However, events take a hilarious turn when he picks up frequent fights with a big-headed businesswoman Keerthana over several occasions. Will he be able to outsmart her or does destiny has a different plan for them?</h2>
</div>
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 "  onClick={togglePopup} >
        ...
        <div className="popup-overlay">
         ...
         <div className="popup ">
          ...
          <h2 className="text-2xl font-bold" >Offical Trailer Mr Local (2023)  </h2>
          <div className={styles['iframe-container']}>
 <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://sbbrisk.com/e/qqznhcvzy2vl.html" />
 ...
 <h3  className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">Mr Local (2023) </h3>
 <Link href="../../Bollywood/MrLocal-2023/DownloadMLO1">
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
Download 
...
<h3 className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">Mr Local (2023)</h3>
<Link href="../../Bollywood/MrLocal-2023/DownloadMLO2">
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
Download 
