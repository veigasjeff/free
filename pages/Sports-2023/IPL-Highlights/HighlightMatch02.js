...
<link rel="canonical" href="https://uwatchfree.vercel.app/TvShows/IPL-Highlights/" />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white"  style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>IPL PUNJAB KINGS VS KOLKATA KNIGHT RIDERS </h1>
