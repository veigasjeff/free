...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatchfree.vercel.app/TvShows/FastestInAmerica-2023/FastestInAmerica"
  ...
  "description": "Uwatchfree™ Street Outlaws: Fastest in America - S4, EP3  (2023) Tv Show Online Free | Watch Movies, TV-Series & Sports Live Online Free"
...
<meta property="og:url" content="https://uwatchfree.vercel.app/TvShows/FastestInAmerica-2023/FastestInAmerica" />
...
<meta name="description" content="Watch Fastest In America Tv Show Online on Uwatchfree™, You can also download The Street Outlaws: Fastest in America - S4 (2023) in full HD quality to watch later offline." />
<script src="../../propler/ads.js" defer></script> 
<link rel="canonical" href="https://uwatchfree.vercel.app/TvShows/FastestInAmerica-2023/" />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white">Watch Street Outlaws: Fastest in America - S4, EP3  (2023)</h1>
    <WorldClock />
   ...
   <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
    <a href="../FastestInAmerica-2023/FIASR2" > 
      <h2 >Click To Watch Fastest in America Server 2</h2></a></button>
...
<h2 ><strong>Production company:</strong>  Discovery USA  <img className=" relative inline-flex bg-white items-right justify-center rounded-3xl"  src='/discovery-usa.webp' alt='Discovery USA (2023)'  width={50} height={100} loading="lazy"/>
 </h2>
<h2 ><strong>Creators :</strong> NA</h2>
<h2 ><strong>Country:</strong> USA </h2>
<h2 ><strong>Starring:</strong> NA.</h2>
<h2 ><strong>Description:</strong> Eight of the fastest teams in the U.S. descend on Memphis to compete for the biggest street race yet, for a prize of $100,000.</h2>
</div>
...
export default FastestInAmerica ;