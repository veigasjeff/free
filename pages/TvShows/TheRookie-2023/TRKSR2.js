...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatchfree.vercel.app/TvShows/TheRookie-2023/TheRookie"
    
  },
  "headline": "The Rookie - S5 (2023) Tv Show Online Free | Uwatchfree™",
  "image": "https://uwatchfree.vercel.app/the-rookie-2023.webp",
  ...
  "description": "Uwatchfree™ The Rookie - S5 (2023) Tv Show Online Free | Watch Movies, TV-Series & Sports Live Online Free"
...
function togglePopup() {
  ...
  />
     <Head>
     <title>Watch The Rookie - S5 (2023) Tv Show Online Free | Uwatchfree™</title>
...
<meta property="og:title" content="Watch The Rookie - S5 (2023) | Uwatchfree™" />
<meta property="og:url" content="https://uwatchfree.vercel.app/TvShows/TheRookie-2023/TheRookie" />
<meta property="og:image" content="https://uwatchfree.vercel.app/the-rookie-2023.webp" />
<meta property="og:image:secure_url" content="https://uwatchfree.vercel.app/" />
<meta property="og:image:width" content="1280" />
<meta property="og:image:height" content="720" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:title" content="Watch The Rookie - S5 (2023) | Uwatchfree™" />
<meta name="twitter:image" content="https://uwatchfree.vercel.app/the-rookie-2023.webp" />
<meta name="description" content="Watch The Rookie S3 Tv Show Online on Uwatchfree™, You can also download The Rookie - S5 (2023) in full HD quality to watch later offline." />
<script src="../../propler/ads.js" defer></script> 
<link rel="canonical" href="https://uwatchfree.vercel.app/TvShows/TheRookie-2023/" />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white"  style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>Watch The Rookie - S5 (2023) </h1>
    <WorldClock />
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
   ...
   <a href="../TheRookie-2023/TheRookie" > 
      <h2 >Click To Watch The Rookie Server 1</h2></a></button>
...
<div>
    ...
    <a href="https://www.imdb.com/title/tt23624888/" target="_blank" > 
...
<h2 ><strong>Genre:</strong> Action, Drama, Crime Show.</h2>
...
<h2 ><strong>Creators :</strong> Alexi Hawley</h2>
<h2 ><strong>Country:</strong> USA </h2>
<h2 ><strong>Starring:</strong> Nathan Fillion, Alyssa Diaz, Richard T. Jones, Melissa O'Neil, Eric Winter, Mekia Cox, Shawn Ashmore, Titus Makin Jr., Brent Huff, Jenna Dewan, Tru Valentino, Jan M. Janssen.</h2>
<h2 ><strong>Description:</strong> Starting over isn't easy, especially for John Nolan who, after a life-altering incident, is pursuing his dream of joining the LAPD. As their oldest rookie, he's met with skepticism from those who see him as just a walking midlife crisis.</h2>
</div>
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 "  onClick={togglePopup} >
        ...
        <div className="popup-overlay">
         ...
         <div className="popup ">
          ...
          <h2 className="text-2xl font-bold" >Offical Trailer The Rookie Season 3, Episode 59 (2023)</h2>
           <div className={styles['iframe-container']}>
 <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://sbface.com/e/ldm8cuzkc1kt.html" />
