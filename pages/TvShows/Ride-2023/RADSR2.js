...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatchfree.vercel.app/TvShows/Ride-2023/Ride"
    
  },
  "headline": "The Equalizer (2023) Tv Show Online Free | Uwatchfree™",
  "image": "https://uwatchfree.vercel.app/ride.webp",
...
function togglePopup() {
  ...
  />
     <Head>
     <title>Watch Ride (2023) Tv Show Online Free | Uwatchfree™</title>
...
<meta property="og:url" content="https://uwatchfree.vercel.app/TvShows/Ride-2023/Ride" />
<meta property="og:image" content="https://uwatchfree.vercel.app/ride.webp" />
...
<link rel="canonical" href="https://uwatchfree.vercel.app/TvShows/Ride-2023/" />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white"  style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>Watch Ride - Season 1, Episode 1 • Premiere (2023)</h1>
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
    <a href="../Ride-2023/Ride" > 
      <h2 >Click To Watch Ride Server 1</h2></a></button>
...
<div>
    ...
    <a href="https://www.imdb.com/title/tt21043326/" target="_blank" > 
...
<h2 ><strong>Director:</strong>Production Company - Hallmark Channel </h2>
<h2 ><strong>Creators :</strong> Paolo Barzman</h2>
<h2 ><strong>Country:</strong> USA </h2>
<h2 ><strong>Starring:</strong> Nancy Travis, Beau Mirchoff, Tiera Skovbye, Tyler Jacob Moore, Sara Garcia, Jake Foy, Vasilios Filippakis, Greg Lawson, Isla Spencer, Dylan Neal, Hugo Raymundo, James Gallanders, Stuart Bentley.</h2>
<h2 ><strong>Description:</strong>With Nancy Travis, Beau Mirchoff, Tiera Skovbye, Tyler Jacob Moore. Follows the lives of the McMurrays as they struggle to keep their beloved ranch </h2>
</div>
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 "  onClick={togglePopup} >
        ...
        <div className="popup-overlay">
         ...
         <div className="popup ">
          ...
          <h2 className="text-2xl font-bold" >Offical Trailer Ride (2023)</h2>
           <div className={styles['iframe-container']}>
 <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://sbface.com/e/qp09f34m6j45.html" />
