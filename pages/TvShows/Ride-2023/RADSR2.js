...
const schemaData   = {
  ...
  "headline": "Ride (2023) Tv Show Online Free | Uwatchfree™",
  ...
  "description": "Uwatchfree™ Ride - S27, EP11 (2023) Tv Show Online Free | Watch Movies, TV-Series & Sports Live Online Free"
...
<link rel="canonical" href="https://uwatchfree.vercel.app/TvShows/Ride-2023/" />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white">Watch Ride - S27, EP11 (2023)</h1>
    <WorldClock />
...
<h2 ><strong>Production company:</strong> Hallmark Channel <img className=" relative inline-flex bg-white items-right justify-center rounded-3xl"  src='/hallmark.webp' alt='Hallmark Channel (2023)'  width={50} height={100} loading="lazy"/>
 </h2>
