...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatchfree.vercel.app/TvShows/IheartRadioMusicAwards-2023/IheartRadioMusicAwards"
    
  },
  "headline": "The IheartRadio Music Awards (2023) Tv Show Online Free | Uwatchfree™",
  "image": "https://uwatchfree.vercel.app/iheart-radio-music-awards-2023.webp",
  ...
  "description": "Uwatchfree™ iHeartRadio Music Awards (2023) Tv Show Online Free | Watch Movies, TV-Series & Sports Live Online Free"
...
function togglePopup() {
  ...
  />
     <Head>
     <title>Watch The IheartRadio Music Awards (2023) Tv Show Online Free | Uwatchfree™</title>
...
<meta property="og:title" content="Watch The IheartRadio Music Awards (2023)| Uwatchfree™" />
<meta property="og:url" content="https://uwatchfree.vercel.app/TvShows/IheartRadioMusicAwards-2023/IheartRadioMusicAwards" />
<meta property="og:image" content="https://uwatchfree.vercel.app/iheart-radio-music-awards-2023.webp" />
<meta property="og:image:secure_url" content="https://uwatchfree.vercel.app/" />
<meta property="og:image:width" content="1280" />
<meta property="og:image:height" content="720" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:title" content="Watch The IheartRadio Music Awards (2023)| Uwatchfree™" />
<meta name="twitter:image" content="https://uwatchfree.vercel.app/iheart-radio-music-awards-2023.webp" />
<meta name="description" content="Watch IheartRadio Music Awards Tv Show Online on Uwatchfree™, You can also download The The IheartRadio Music Awards (2023) in full HD quality to watch later offline." />
<script src="../../propler/ads.js" defer></script> 
<link rel="canonical" href="https://uwatchfree.vercel.app/TvShows/IheartRadioMusicAwards-2023/" />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white">Watch iHeartRadio Music Awards (2023)</h1>
    <WorldClock />
   ...
   <a href="../IheartRadioMusicAwards-2023/BLTSR2" > 
      <h2 >Click To Watch iHeartRadio Music Awards Server 2</h2></a></button>
...
<div>
    ...
    <a href="https://www.imdb.com/title/tt17507404/" target="_blank" > 
...
<h2 ><strong>Production company:</strong>  FOX USA  <img className=" relative inline-flex bg-white items-right justify-center rounded-3xl"  src='/fox.webp' alt='iHEARTRADIO MUSIC AWARDS (2023)'  width={50} height={100} loading="lazy"/>
 </h2>
<h2 ><strong>Creators :</strong> Joe DeMaio</h2>
<h2 ><strong>Country:</strong> USA </h2>
<h2 ><strong>Starring:</strong> Dove Cameron, Jennifer Lopez, Gina Torres, Colson Baker, Danica McKellar, Nicole Scherzinger, aylor Momsen, Billy Porter, Oliver Hudson, Olivia Rodrigo, LL Cool J, Lainey Wilson, Camila Cabello, Heidi Klum.</h2>
<h2 ><strong>Description:</strong> Afrobeats Artist of the Year. Burna Boy. CKay. Fireboy DML. Tems. Wizkid. Alternative Artist of the Year. Imagine Dragons. Måneskin. Red Hot Chili Peppers.</h2>
</div>
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 "  onClick={togglePopup} >
        ...
        <div className="popup-overlay">
         ...
         <div className="popup ">
          ...
          <h2 className="text-2xl font-bold" >Offical Trailer IheartRadio Music Awards (2023)</h2>
           <div className={styles['iframe-container']}>
 <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitAllowFullScreen mozallowfullscreen allowFullScreen src="https://sbface.com/e/2xqyc6erajg8.html" />                   
             </div></div>
          </div>
...
export default IheartRadioMusicAwards ;