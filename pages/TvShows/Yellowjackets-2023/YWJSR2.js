...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatchfree.vercel.app/TvShows/Yellowjackets-2023/TheBachelor"
    
  },
  "headline": "Yellowjackets - S2 (2023) Tv Show Online Free | Uwatchfree™",
  ...
  "description": "Uwatchfree™ Yellowjackets - S2, EP 1 • Premier (2023) Tv Show Online Free | Watch Movies, TV-Series & Sports Live Online Free"
...
<link rel="canonical" href="https://uwatchfree.vercel.app/TvShows/Yellowjackets-2023/" />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white">Watch Yellowjackets - S2, EP 1 • Premier (2023)</h1>
    <WorldClock />
   ...
   <a href="../Yellowjackets-2023/Yellowjackets" > 
      <h2 >Click To Watch Yellowjackets Server 1</h2></a></button>
...
<h2 ><strong>Production company:</strong> Showtime USA  <img className=" relative inline-flex bg-white items-right justify-center rounded-3xl"  src='/showtime.webp' alt='Showtime USA (2023)'  width={50} height={100} loading="lazy"/>
 </h2>
