...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatchfree.vercel.app/TvShows/TheEqualizer-2023/TheEqualizer"
    
  },
  "headline": "The Equalizer - S3, EP13 (2023) Tv Show Online Free | Uwatchfree™",
  "image": "https://uwatchfree.vercel.app/the-equalizer.webp",
...
function togglePopup() {
  ...
  />
     <Head>
     <title>Watch The Equalizer (2023) Tv Show Online Free | Uwatchfree™</title>
...
<meta property="og:title" content="Watch The Equalizer (2023)| Uwatchfree™" />
<meta property="og:url" content="https://uwatchfree.vercel.app/TvShows/TheEqualizer-2023/TheEqualizer" />
<meta property="og:image" content="https://uwatchfree.vercel.app/the-equalizer.webp" />
<meta property="og:image:secure_url" content="https://uwatchfree.vercel.app/" />
<meta property="og:image:width" content="1280" />
<meta property="og:image:height" content="720" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:title" content="Watch The Equalizer (2023)| Uwatchfree™" />
<meta name="twitter:image" content="https://uwatchfree.vercel.app/the-equalizer.webp" />
<meta name="description" content="Watch The Equalizer Tv Show Online on Uwatchfree™, You can also download The Equalizer  (2023) in full HD quality to watch later offline." />
<script src="../../propler/ads.js" defer></script> 
<link rel="canonical" href="https://uwatchfree.vercel.app/TvShows/TheEqualizer-2023/" />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white"  style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>Watch The Equalizer - S3, EP13 (2023)</h1>
    <h2 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white">Sunday 26th March 2023 - Schedule Time UK GMT+1 @ 01:00 </h2>
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
    <a href="../TheEqualizer-2023/TheEqualizer" > 
      <h2 >Click To Watch The Equalizer Server 2</h2></a></button>
...
<div>
    ...
    <a href="https://www.imdb.com/title/tt11242246/" target="_blank" > 
...
<h2 ><strong>Genre:</strong> Action, Crime, Drama.</h2>
<h2 ><strong>Release year:</strong> 2023</h2>
<h2 ><strong>Director:</strong>Production Company - CBS USA  </h2>
<h2 ><strong>Creators</strong>Andrew W. Marlowe, Terri Edda Miller</h2>
<h2 ><strong>Country:</strong> USA </h2>
<h2 ><strong>Starring:</strong> Queen Latifah, Tory Kittles, Adam Goldberg, Liza Lapira, Laya DeLeon Hayes, Lorraine Toussaint, Chris Noth, Jennifer Ferrin, Tony DeMil, Brett Dalton, Stephen Bishop, Erica Camarano, Dominic Fumusa.</h2>
<h2 ><strong>Description:</strong>An enigmatic figure who uses her extensive skills to help those with nowhere else to turn.</h2>
</div>
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 "  onClick={togglePopup} >
        ...
        <div className="popup-overlay">
         ...
         <div className="popup ">
          ...
          <h2 className="text-2xl font-bold" >Offical Trailer The Equalizer (2023)</h2>
           <div className={styles['iframe-container']}>
 <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://sbface.com/e/p5eyd4hp56q5.html" />
