...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatchfree.vercel.app/TvShows/LuckyHank-2023/LuckyHank"
    
  },
  "headline": "The Equalizer (2023) Tv Show Online Free | Uwatchfree™",
  "image": "https://uwatchfree.vercel.app/lucky-hank.webp",
...
function togglePopup() {
  ...
  />
     <Head>
     <title>Watch Lucky Hank - S1 (2023) Tv Show Online Free | Uwatchfree™</title>
...
<meta property="og:title" content="Watch Lucky Hank - S1 (2023)| Uwatchfree™" />
<meta property="og:url" content="https://uwatchfree.vercel.app/TvShows/LuckyHank-2023/LuckyHank" />
<meta property="og:image" content="https://uwatchfree.vercel.app/lucky-hank.webp" />
...
<link rel="canonical" href="https://uwatchfree.vercel.app/TvShows/LuckyHank-2023/" />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white"  style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>Watch Lucky Hank - S1, EP2 (2023)</h1>
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
    <a href="../LuckyHank-2023/LuckyHank" > 
      <h2 >Click To Watch Lucky Hank Server 1</h2></a></button>
