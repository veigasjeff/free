...
const schemaData   = {
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://uwatchfree.vercel.app/TvShows/Lacasadelosfamosos-2023/Lacasadelosfamosos"
    
  },
  "headline": "La casa de los famosos S3 (2023) Tv Show Online Free | Uwatchfree™",
  "image": "https://uwatchfree.vercel.app/La-casa-de-los-amosos.webp",
  ...
  "description": "Uwatchfree™ La casa de los famosos S3 (2023) Tv Show Online Free | Watch Movies, TV-Series & Sports Live Online Free"
...
function togglePopup() {
  ...
  />
     <Head>
     <title>Watch La casa de los famosos S3 (2023) Tv Show Online Free | Uwatchfree™</title>
...
<meta property="og:title" content="Watch La casa de los famosos S3 (2023) | Uwatchfree™" />
<meta property="og:url" content="https://uwatchfree.vercel.app/TvShows/Lacasadelosfamosos-2023/Lacasadelosfamosos" />
<meta property="og:image" content="https://uwatchfree.vercel.app/La-casa-de-los-amosos.webp" />
...
<link rel="canonical" href="https://uwatchfree.vercel.app/TvShows/Lacasadelosfamosos-2023/" />
    ...
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white"  style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>Watch La casa de los famosos S3 (2023) </h1>
    <WorldClock />
    <h2 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white"> Schedule Time UK GMT+1 @ 00:00 </h2>
    ...
    <h3 className="mb-9 text-bg  text-black-500 text-white text-center xl:px-4 ">
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
   ...
   <a href="../Lacasadelosfamosos-2023/LDFSR2" > 
      <h2 >Click To Watch La casa de los famosos Server 2</h2></a></button>
   ...
   <h2 className="text-white font-bold text-xl ">  5.7 Out of 10</h2>
...
<div>
    ...
    <a href="https://www.imdb.com/title/tt16022138/" target="_blank" > 
...
<h2 ><strong>Production Company:</strong>  Telemundo Studios  <img className=" relative inline-flex bg-white items-right justify-center rounded-3xl"  src='/telemundo.webp' alt='Telemundo Studios (2023)'  width={50} height={100} loading="lazy"/>
 </h2>
<h2 ><strong>Creators :</strong> NA </h2>
<h2 ><strong>Country:</strong> USA </h2>
<h2 ><strong>Starring:</strong> Dania Mendez, Alicia Machado, Manelyk González, Gabriela Spanic, Christian de la Campa, Veronica Montes, Pablo Montero, Celia Lora, Jorge Aravena, Uriel del Toro, Roberto Romano, Gisella Aboumrad.</h2>
<h2 ><strong>Description:</strong> Celebrities gathered under one roof and cut off from the outside world are recorded by cameras 24 hours a day, seven days a week, as they compete with one goal: to win.</h2>
</div>
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 "  onClick={togglePopup} >
        ...
        <div className="popup-overlay">
         ...
         <div className="popup ">
          ...
          <h2 className="text-2xl font-bold" >Offical Trailer La casa de los famosos Season 3, Episode 59 (2023)</h2>
           <div className={styles['iframe-container']}>
 <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://sbface.com/e/ztlwgnfumcv8.html" />
...
export default Lacasadelosfamosos ;