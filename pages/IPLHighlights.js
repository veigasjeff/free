...
const IPLHighlights = ({ }) => {
  const images = [
    ...
    { src: '/ipl-2023-highlight06.webp', alt: 'IPL MATCH 05 CSK VS LSG (2023)', link: '../../Sports-2023/IPL-Highlights/HighlightMatch056', text: 'IPL MATCH 06 CHENNAI SUPER KINGS vs LUCKNOW SUPER GIANTS (2023)' },
  ];
 {/*
