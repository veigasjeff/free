...
const IPLHighlights = ({ }) => {
  const images = [
    { src: '/ipl-2023-gtvscsk.webp', alt: 'IPL MATCH 01 GT VS CSK (2023)', link: '/', text: 'IPL MATCH 01 GUJARAT TITANS VS CHENNAI SUPER KINGS (2023)' },
    { src: '/coming-soon.webp', alt: 'IPL MATCH 02 	PBKS VS KKR (2023)', link: '/', text: 'IPL MATCH 02 PUNJAB KINGS VS KOLKATA KNIGHT RIDERS (2023)' },
    { src: '/coming-soon.webp', alt: 'IPL MATCH 03 LSG VS DC (2023)', link: '/', text: 'IPL MATCH 03 LUCKNOW SUPER GIANTS VS DELHI CAPITALS (2023)' },
