...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123moviesmagazine.vercel.app/movies-page1/',
  headline: 'Download movies | Movies Magazine™',
  url: 'https://123moviesmagazine.vercel.app/movies-page1/',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Movies',
      item: 'https://123moviesmagazine.vercel.app/movies/'
    },
     {
      '@type': 'ListItem',
      position: 3,
      name: 'Movies Page 1',
      item: 'https://123moviesmagazine.vercel.app/movies-page1/'
    }
  ]
})
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <link rel='canonical' href='https://123moviesmagazine.vercel.app/movies-page1/' />
        <meta
          name='robots'
        ...
        <meta
          property='og:url'
          content='https://123moviesmagazine.vercel.app/movies-page1'
        />
        ...
        <meta
          ...
          content='https://123moviesmagazine.vercel.app/wp-content/uploads/movies.webp'
        />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://123moviesmagazine.vercel.app/moviesp1.json')
