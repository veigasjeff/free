...
const schemaData   = {
  ...
  <img className="w-full h-full object-cover rounded-3xl border border-white shadow-md"  src={movie.poster} alt={movie.title} width="626" height="417" rel="preload" priority={true} />
