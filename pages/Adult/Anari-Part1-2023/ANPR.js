...
function AnariPart1({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate: "https://uwatchfree.vercel.app/Adult/Anari-Part1-2023/ANPR",
  ...
  return (
    <div>
      ...
      />
      <Head>
        <title>Watch Anari Part 1 (2023) Full Movie Online Free | Uwatchfree™</title>
        <meta
          name="robots"
        ...
        <meta
          name="keywords"
          content="anari part 1, anari part 1 2023 online, watch hindi movie anari part 1 online, watch anari part 1 2023, anari part 1 hd streaming online, anari part 1 videos, hot, romance, anari part 1 cast, hindi movie, anari part 1 18+ movie, anari part 1 movie download, new release, new hindi movie, uwatchfree, blockbuster movie, uwatchfree movies, adult movies"
        />
        ...
        <meta property="og:title" content="Watch Anari Part 1 (2023) | Uwatchfree™" />
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Adult/Anari-Part1-2023/ANPR"
        />
        <meta
          property="og:image"
          content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1689195704/Anari-Part1-2023_ayysyc.webp"
        />
        <meta
        ...
        <meta
          name="twitter:title"
          content="Watch Anari Part 1 (2023) | Uwatchfree™"
        />
        <meta
          name="twitter:image"
          content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1689195704/Anari-Part1-2023_ayysyc.webp"
        ...
        <meta
          name="description"
          content="Watch Anari Part 1 Full Movie Online on Uwatchfree™, You can also Watch Now Or Download To Watch Later!"
        />

        <link
          rel="canonical"
          href="https://uwatchfree.vercel.app/Adult/Anari-Part1-2023/Anari-Part1"
        />
      </Head>
      ...
      <div className="bg-gray-600 shadow ">
        ...
        <button className="relative inline-flex items-center animate-pulse rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110 cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
           <a href="../../Adult/Anari-Part1-2023/Anari-Part1" >  
      <h2 > Change Server {movie.name}   </h2></a></button>
        ...
        <h2
          ...
          style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
        >
          Listen to Audio Summary Anari Part 1 (2023)
        </h2>
        <div
        ...
        >
          ...
          >
           <source src="https://ik.imagekit.io/gmcl6xvq6/Anari___Part_-_1___Official_Trailer.mp4?updatedAt=1689195675308" />
          </audio>
        </div>
        ...
        >
          ...
          <h2
            ...
            style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}
          >
            In the Movie Anari Part 1 (2023)
          </h2>
