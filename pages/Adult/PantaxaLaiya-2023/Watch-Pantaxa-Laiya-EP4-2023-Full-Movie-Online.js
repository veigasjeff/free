      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Adult/PantaxaLaiya-2023/Watch-Pantaxa-Laiya-EP1-2023-Full-Movie-Online",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Adult/PantaxaLaiya-2023/Watch-Pantaxa-Laiya-EP4-2023-Full-Movie-Online"
        />
        <meta
          property="og:image"
      ...
      <div className="bg-gray-600 shadow ">
        ...
        <div className="grid grid-cols-1 mx-20 sm:grid-cols-2  x:grid-cols-3 gap-4">
          <div className="flex justify-center">
            <Link href="../../Adult/PantaxaLaiya-2023/Watch-Pantaxa-Laiya-EP1-2023-Full-Movie-Online">
          ...
          <div className="flex justify-center">
            <Link href="../../Adult/PantaxaLaiya-2023/Watch-Pantaxa-Laiya-EP2-2023-Full-Movie-Online">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2 ">
                Episode 2
              </button>
            </Link>
          ...
          <div className="flex justify-center">
            <Link href="../../Adult/PantaxaLaiya-2023/Watch-Pantaxa-Laiya-EP3-2023-Full-Movie-Online">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
                Episode 3
              </button>
            </Link>
          ...
          <div className="flex justify-center">
            <Link href="../../Adult/PantaxaLaiya-2023/Watch-Pantaxa-Laiya-EP5-2023-Full-Movie-Online">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2 ">
                Episode 5
              </button>
            </Link>
        ...
        <div className="flex justify-center">
          <Link href="../../Adult/PantaxaLaiya-2023/Watch-Pantaxa-Laiya-EP6-2023-Full-Movie-Online">
            <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
              Episode 6
            </button>
          </Link>
