      ...
      target: [
        {
          ...
          name: "Dosti S01 (2023)",
          urlTemplate:
            "https://uwatchfree.vercel.app/Adult/DostiS01-2023/Watch-Dosti-EP1-2023-Movie",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Adult/DostiS01-2023/Watch-Dosti-EP1-2023-Movie"
        />
        <meta
          property="og:image"
      ...
      <div className="bg-gray-600 shadow ">
        ...
        <div className="grid grid-cols-1 mx-20 sm:grid-cols-2  x:grid-cols-3 gap-4">
          <div className="flex justify-center">
            <Link href="../../Adult/DostiS01-2023/Watch-Dosti-EP2-2023-Movie">
