      ...
      target: [
        {
          "@type": "EntryPoint",
          name: "Hilom (2023) ",
          urlTemplate: "https://uwatchfree.vercel.app/Adult/Hilom-2023/Watch-Hilom-2023-Full-Movie-Online",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Adult/Hilom-2023/Watch-Hilom-2023-Full-Movie-Online"
        />
        <meta
          property="og:image"
...
export async function getServerSideProps() {
  ...
  const selectedMovie = data.find((movie) => movie.id === "INDEX89");
  return {
    props: {
      movie: selectedMovie,
    },
