...
function SEXSR1({ movie }) {
      ...
      target: [
        {
          ...
          name: "Sex Hub (2023)",
          urlTemplate:
            "https://uwatchfree.vercel.app/Adult/SexHub-2023/SexHub",
        },
        {
          "@type": "EntryPoint",
          name: "Sex Hub (2023)",
          urlTemplate:
            "https://uwatchfree.vercel.app/Adult/SexHub-2023/SEXSR1",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch Sex Hub (2023) Full Movie Online Free | Uwatchfree™
        </title>
        <meta
          name="robots"
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Adult/SexHub-2023/SEXSR1"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch Taak Jhank Full Movie Online on Uwatchfree™, You can also download Sex Hub (2023) in full HD quality to watch later offline."
        />
