...
function RikshawalaP2({ movie }) {
      ...
      target: [
        {
          ...
          urlTemplate:
            "https://uwatchfree.vercel.app/Adult/RikshawalaPart1-2023/Watch-Rikshawala-EP1-2023-Full-Movie-Online",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch Rikshawala Episode 2 (2023) Full Movie Online Free | Uwatchfree™
        </title>
        <meta
          name="robots"
        ...
        <meta
          name="keywords"
          content="uwatchfree,watch free movies,full movie online free,hd movies,movie 2023,latest movie,dubbed movies,free movie download,watch rikshawala part 1 movie,index of rikshawala part 1 movie,rikshawala part 1 movie 2023,rikshawala part 1 movie online,watch rikshawala part 1 movie online free,rikshawala part 1 tv series,rikshawala part 1 movie download,rikshawala part 1 movie free download,rikshawala part 1 movie download"
        />
        ...
        <meta
          property="og:title"
          content="Watch Rikshawala Part 1 (2023) | Uwatchfree™"
        />
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Adult/RikshawalaPart1-2023/Watch-Rikshawala-EP2-2023-Full-Movie-Online"
        />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Watch Rikshawala Full Movie Online on Uwatchfree™, You can also download Rikshawala Part 1 (2023) in full HD quality to watch later offline."
        />
      ...
      <div className="bg-gray-600 shadow ">
        ...
        <div className="grid grid-cols-1 mx-20 sm:grid-cols-2  x:grid-cols-3 gap-4">
          <div className="flex justify-center">
            <Link href="../../Adult/Rikshawala-2023/Watch-Rikshawala-EP1-2023-Full-Movie-Online">
          ...
          <div className="flex justify-center">
            <Link href="../../Adult/Rikshawala-2023/Watch-Rikshawala-EP3-2023-Full-Movie-Online">
              <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-white-500 border-2">
                Episode 3
              </button>
            </Link>
