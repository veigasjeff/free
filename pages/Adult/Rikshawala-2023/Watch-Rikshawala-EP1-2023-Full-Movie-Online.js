...
function RikshawalaP1({ movie }) {
  ...
  return (
    <div>
      ...
      <Head>
        <title>
          Watch Rikshawala Episode 1 (2023) Full Movie Online Free | Uwatchfree™
        </title>
        <meta
          name="robots"
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Adult/RikshawalaPart1-2023/Watch-Rikshawala-EP1-2023-Full-Movie-Online"
        />
        <meta
          property="og:image"
      ...
      <div className="bg-gray-600 shadow ">
        ...
        <div className="grid grid-cols-1 mx-20 sm:grid-cols-2  x:grid-cols-3 gap-4">
          <div className="flex justify-center">
            <Link href="../../Adult/Rikshawala-2023/Watch-Rikshawala-EP2-2023-Full-Movie-Online">
