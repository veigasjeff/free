...
function TohfaEP1 ({ movie }) {
      ...
      target: [
        {
          "@type": "EntryPoint",
          name: "Tohfa  (2023) ",
          urlTemplate: "https://uwatchfree.vercel.app/Adult/Tohfa-2023/Watch-Tohfa-EP1-2023-Full-Movie-Online",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Adult/Tohfa-2023/Watch-Tohfa-EP1-2023-Full-Movie-Online"
        />
        <meta
          property="og:image"
  ...
  <div className="flex justify-center">
          <Link href="../../Adult/Tohfa-2023/Watch-Tohfa-EP2-2023-Full-Movie-Online">
