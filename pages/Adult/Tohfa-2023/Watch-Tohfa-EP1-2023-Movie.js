...
function TohfaEP1 ({ movie }) {
      ...
      target: [
        {
          "@type": "EntryPoint",
          name: "Tohfa  (2023) ",
          urlTemplate: "https://uwatchfree.vercel.app/Adult/Tohfa-2023/Watch-Tohfa-EP1-2023-Movie",
        },
      ],
    },
    aggregateRating: {
  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta
          property="og:url"
          content="https://uwatchfree.vercel.app/Adult/Tohfa-2023/Watch-Tohfa-EP1-2023-Movie"
        />
        <meta
          property="og:image"
  ...
  <div className="flex justify-center">
          <Link href="../../Adult/Tohfa-2023/Watch-Tohfa-EP2-2023-Movie">
