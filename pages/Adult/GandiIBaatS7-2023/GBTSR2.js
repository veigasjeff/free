...
const schemaData   = {
  ...
  "image": "https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610057/gandii-baat-s7-2023_nedy5m.webp",
  ...
  "description": "Uwatchfree™ Gandii Baat Season 7 (2023) Full Movie Online Free | Watch Movies, TV-Series & Sports Live Online Free."
...
<meta name="keywords" content="uwatchfree,watch free movies,full movie online free,hd movies,movie 2023,latest movie,dubbed movies,free movie download,watch gandii baat movie,index of gandii baat movie,gandii baat movie 2023,gandii baat movie online,watch gandii baat movie online free,gandii baat tv series,gandii baat movie download,gandii baat movie free download,gandii baat movie download" />
...
<meta property="og:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1681610057/gandii-baat-s7-2023_nedy5m.webp" />
...
<link rel="canonical" href="https://uwatchfree.vercel.app/Adult/GandiIBaatS7-2023/GBTSR2" />
...
<Script src="../../propler/ads.js" defer />
      ...
      <div className="bg-gray-600 ">
         ...
         <AdultSkipAds />
    <h1 className="mb-4 py-5 font-bold leading-none tracking-tight text-white  text-center md:text-2xl lg:text-3xl dark:text-white"  style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>Watch Gandii Baat Season 7 (2023) </h1>

    <div className={styles['iframe-container']}>
      <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://dood.yt/e/nsvhlizedgo5" />
    </div>    
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
    <a href="../GandiIBaatS7-2023/GandiIBaatS7" > 
      <h2 > Watch Gandii Baat Season 7 (2023) Server 1</h2></a></button>
...
<h2 ><strong>Director:</strong> Punit (P.G) - ALTT Originals App</h2>
<h2 ><strong>Country:</strong> Indian</h2>
<h2 ><strong>Starring:</strong> Garima Maurya, Basant Kumar, Sreoshi Chatterjee, Jinal Jain, Bhanu Suryam Thakur, Shivangi Roy, Bhavna Rokade, Yash Gera, Manvi Chugh </h2>
<h2 ><strong>Description:</strong> The plot revolves around multiple individuals and their life during lockdown. They decide to enjoy life in different ways.</h2>
</div>
...
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-2 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 "  onClick={togglePopup} >
        ...
        <div className="popup-overlay">
         ...
         <div className="popup ">
          ...
          <h2 className="text-2xl font-bold" >Offical Trailer Gandii Baat Season 7 (2023) </h2>
           <div className={styles['iframe-container']}>
 <iframe className="  rounded-3xl  mr-8 flex  border-1 border-blue-600 bg-gray-600 p-2 " webkitallowFullScreen mozallowFullScreen allowFullScreen src="https://sbbrisk.com/e/eew2e0dwidve.html" />
    ...
    <h3  className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">Gandii Baat Season 7 (2023) </h3>
    <Link href="../../Adult/GandiIBaatS7-2023/DownloadGBT1">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
Download 
  ...
  <h3 className="text-xl font-bold leading-normal mt-0 mb-2 text-blue-600 ">Gandii Baat Season 7 (2023)</h3>
  <Link href="../../Adult/GandiIBaatS7-2023/DownloadGBT2">
<button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
Download 
