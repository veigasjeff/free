...
function KajalBhabhiP2({ movie }) {
  ...
  const ldJsonData = JSON.stringify({
    ...
    "potentialAction": {
      ...
      "target": [
        {
          "@type": "EntryPoint",
          "name": "Kajal Bhabhi (2023)",
          "urlTemplate": "https://uwatchfree.vercel.app/Adult/KajalBhabhi-2023/KajalBhabhiP1"
        },
        {
          "@type": "EntryPoint",
          "name": "Kajal Bhabhi (2023)",
          "urlTemplate": "https://uwatchfree.vercel.app/Adult/KajalBhabhi-2023/KGBSR1"
        },
  ...
  return (
    <div>
      ...
      />
    <Head>
     <title>Watch Kajal Bhabhi (2023) Full Movie Online Free | Uwatchfree™</title>
<meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
<meta name="keywords" content="uwatchfree,kajal bhabhi movie,kajal bhabhi 2023,index of kajal bhabhi movie,kajal bhabhi cast,kajal bhabhi trailer,kajal bhabhi release date,kajal bhabhi plot,kajal bhabhi reviews,kajal bhabhi streaming,kajal bhabhi watch online,kajal bhabhi download,kajal bhabhi full movie,kajal bhabhi movie download,kajal bhabhi movie free download,kajal bhabhi movie online,kajal bhabhi movie watch online,kajal, nitin in kajal bhabhi" />
...
<meta property="og:title" content="Watch Kajal Bhabhi (2023) | Uwatchfree™" />
<meta property="og:url" content="https://uwatchfree.vercel.app/Adult/KajalBhabhi-2023/KajalBhabhiP1" />
<meta property="og:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1683907528/Kajal-Bhabhi-2023_o3nzsi.webp" />
<meta property="og:image:secure_url" content="https://uwatchfree.vercel.app/" />
<meta property="og:image:width" content="1280" />
<meta property="og:image:height" content="720" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:title" content="Watch Kajal Bhabhi (2023) | Uwatchfree™" />
<meta name="twitter:image" content="https://res.cloudinary.com/dezf3wemk/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1683907528/Kajal-Bhabhi-2023_o3nzsi.webp" />
<meta name="description" content="Watch KajalBhabhiP1 Full Movie Online on Uwatchfree™, You can also download Kajal Bhabhi (2023) in full HD quality to watch later offline." />

<link rel="canonical" href="https://uwatchfree.vercel.app/Adult/KajalBhabhi-2023/" />
       </Head>
<Script src="../../propler/ads.js" defer />
    ...
    <Link href="../../Adult/KajalBhabhi-2023/KajalBhabhiP1">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
      Episode 1
      </button></Link>
    </div>
    <div className="flex justify-center">
    <Link href="../../Adult/KajalBhabhi-2023/KajalBhabhiP2">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
      Episode 2
      </button></Link>
    </div>
    <div className="flex justify-center">
    <Link href="../../Adult/KajalBhabhi-2023/KajalBhabhiP3">
  <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
      Episode 3
      </button></Link>
      </div>
           ...
           <button className="relative inline-flex items-center rounded-3xl my-5 justify-center p-0.5 mb-5 mr-2 overflow-hidden text-xl font-bold text-gray-900 group bg-gradient-to-br from-red-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-100 hover:scale-110  cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 ">
           <a href="../KajalBhabhi-2023/KGBSR2" >  
...
export async function getServerSideProps() {
  ...
  const selectedMovie = data.find(movie => movie.id === 'KGB');
  return {
    props: {
      movie: selectedMovie
    }
