...
const BackgroundVideo = ({ src, srcMobile }) => {
  ...
  return (
    <div className="background-video">
      ...
      } group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 scale-120 hover:scale-110 cursor-pointer px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 group-hover:bg-opacity-0 border-red-500 border-2 `} style={{ boxShadow: '0 0 5px 5px rgba(255, 0, 0, 0.7)' }}
    >
      Enter Free
    </button>
